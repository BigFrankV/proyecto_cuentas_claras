...
export default function ParametrosCobranzaPage() {
  ...
  const historialEjemplo: HistorialParametros[] = [
    ...
    },
    {
      ...
      detalles: 'Habilitadas notificaciones 3 días antes, 1 día antes y el día del vencimiento'
    },
    {
      id: 3,
      parametrosId: 1,
  ...
  const handleCuentaBancariaChange = (field: keyof CuentaBancaria, value: string) => {
    setParametros(prev => ({
      ...prev,
      cuentaBancaria: {
        ...prev.cuentaBancaria!,
            ...
            <div className="row align-items-center">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol className="breadcrumb mb-0">
                      <li className="breadcrumb-item">
                        <a href="/comunidades" className="text-decoration-none">Comunidades</a>
                      </li>
                      <li className="breadcrumb-item">
                        <a href={`/comunidades/${id}`} className="text-decoration-none">{comunidadNombre}</a>
                      </li>
                      <li className="breadcrumb-item active">Parámetros de Cobranza</li>
                    </ol>
                  </nav>
                </div>
              </div>
              <div className="col-lg-4 text-end">
                <div className="d-flex align-items-center justify-content-end">
                  ...
                  >
                    <span className="material-icons align-middle me-1">history</span> Ver historial
                  </button>
                  <button 
                    type="submit" 
                  ...
                  >
                    {saving ? (
                      ...
                      <>
                        <span className="material-icons align-middle me-1">save</span> Guardar cambios
                      </>
                    )}
                  </button>
                </div>
        ...
        <div className="container-fluid py-4">
          <div className="row">
            <div className="col-12 mb-4">
              ...
              <p className="text-muted">Configuración de intereses, moras y políticas de pago para {comunidadNombre}</p>
            </div>
          </div>
          ...
          <form id="formParametrosCobranza" onSubmit={handleSubmit}>
            ...
            <div className="param-section">
              <div className="param-header">
                <h4 className="mb-0">
                  <span className="material-icons align-middle me-2">percent</span> 
                  Intereses y Mora
                </h4>
              ...
              <div className="param-body">
                <div className="param-description">
                  Configure cómo se calculan los intereses por mora en los pagos atrasados.
                </div>
                
                <div className="row mb-4">
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label htmlFor="diasGracia" className="form-label">Días de gracia</label>
                      <div className="input-group">
                        <input 
                          ...
                          min="0"
                          onChange={(e) => handleInputChange('diasGracia', Number(e.target.value))}
                        />
                        <span className="input-group-text">días</span>
                      </div>
                      <div className="form-text">Período sin intereses después del vencimiento</div>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label htmlFor="tasaMora" className="form-label">Tasa de interés por mora</label>
                      <div className="input-group">
                        <input 
                          type="number" 
                          className="form-control" 
                          ...
                          step="0.1" 
                          min="0"
                          onChange={(e) => handleInputChange('tasaMora', Number(e.target.value))}
                        />
                        <span className="input-group-text">% mensual</span>
                      </div>
                      <div className="form-text">Interés mensual aplicado a pagos atrasados</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-4">
                    ...
                    <div className="mb-3">
                      ...
                      <div className="form-check mb-2">
                        <input 
                          ...
                          onChange={() => handleInputChange('calculoInteres', 'diario')}
                        />
                        <label className="form-check-label" htmlFor="calculoDiario">
                      ...
                      <div className="form-check">
                        <input 
                          ...
                          onChange={() => handleInputChange('calculoInteres', 'mensual')}
                        />
                        <label className="form-check-label" htmlFor="calculoMensual">
                  ...
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label htmlFor="interesMaximo" className="form-label">Interés máximo mensual</label>
                      <div className="input-group">
                        <input 
                          type="number" 
                          className="form-control" 
                          ...
                          step="0.1" 
                          min="0"
                          onChange={(e) => handleInputChange('interesMaximo', Number(e.target.value))}
                        />
                        <span className="input-group-text">%</span>
                      </div>
                      <div className="form-text">Límite máximo de interés por mes</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="row mb-2">
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label className="form-label">Aplicación del interés sobre</label>
                      <div className="form-check mb-2">
                        <input 
                          className="form-check-input" 
                          type="radio" 
                          ...
                          onChange={() => handleInputChange('aplicacionInteres', 'capital')}
                        />
                        <label className="form-check-label" htmlFor="aplicacionCapital">
                          Capital inicial
                        </label>
                      </div>
                      <div className="form-check">
                        <input 
                          ...
                          onChange={() => handleInputChange('aplicacionInteres', 'saldo')}
                        />
                        <label className="form-check-label" htmlFor="aplicacionSaldo">
                  ...
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label htmlFor="tipoRedondeo" className="form-label">Redondeo de montos</label>
                      <select 
                        className="form-select" 
                        id="tipoRedondeo"
                        value={parametros.tipoRedondeo}
                        onChange={(e) => handleInputChange('tipoRedondeo', e.target.value as 'normal' | 'arriba' | 'abajo')}
                      >
                        <option value="normal">Normal (matemático)</option>
                        <option value="arriba">Hacia arriba</option>
                        <option value="abajo">Hacia abajo</option>
                      </select>
                      <div className="form-text">Tipo de redondeo aplicado a intereses calculados</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="calculation-example">
                  ...
                  <div>Para un cargo de <span className="fw-bold">$100.000</span> con <span className="fw-bold">20 días</span> de atraso:</div>
                  <div className="mt-1">
                    <span className="fw-bold">{ejemploCalculo.descripcion}</span><br />
                    <span className="fw-bold">Interés aplicado:</span> {ejemploCalculo.calculo}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="param-section">
              <div className="param-header">
                <h4 className="mb-0">
                  <span className="material-icons align-middle me-2">payments</span> 
                  Políticas de Pago
                </h4>
              </div>
              <div className="param-body">
                ...
                <div className="row mb-4">
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label className="form-label">Política de aplicación de pagos</label>
                      <div className="form-check mb-2">
                        <input 
                          className="form-check-input" 
                          type="radio" 
                          ...
                          onChange={() => handleInputChange('politicaPago', 'antiguos')}
                        />
                        <label className="form-check-label" htmlFor="politicaAntiguos">
                      ...
                      <div className="form-check mb-2">
                        <input 
                          ...
                          onChange={() => handleInputChange('politicaPago', 'recientes')}
                        />
                        <label className="form-check-label" htmlFor="politicaRecientes">
                      ...
                      <div className="form-check">
                        <input 
                          ...
                          onChange={() => handleInputChange('politicaPago', 'especificada')}
                        />
                        <label className="form-check-label" htmlFor="politicaEspecificada">
                  ...
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label className="form-label">Orden de aplicación en cada cargo</label>
                      <div className="form-check mb-2">
                        <input 
                          className="form-check-input" 
                          type="radio" 
                          ...
                          id="ordenInteres"
                          checked={parametros.ordenAplicacion === 'interes-capital'}
                          onChange={() => handleInputChange('ordenAplicacion', 'interes-capital')}
                        />
                        <label className="form-check-label" htmlFor="ordenInteres">
                      ...
                      <div className="form-check">
                        <input 
                          ...
                          name="ordenAplicacion" 
                          id="ordenCapital"
                          checked={parametros.ordenAplicacion === 'capital-interes'}
                          onChange={() => handleInputChange('ordenAplicacion', 'capital-interes')}
                        />
                        <label className="form-check-label" htmlFor="ordenCapital">
                ...
                <div className="row mb-4">
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label htmlFor="diaEmision" className="form-label">Día de emisión mensual</label>
                      <div className="input-group">
                        <input 
                          type="number" 
                          className="form-control" 
                          ...
                          min="1" 
                          max="28"
                          onChange={(e) => handleInputChange('diaEmision', Number(e.target.value))}
                        />
                        <span className="input-group-text">del mes</span>
                      </div>
                      <div className="form-text">Día en que se emiten los gastos comunes</div>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label htmlFor="diaVencimiento" className="form-label">Día de vencimiento mensual</label>
                      <div className="input-group">
                        <input 
                          type="number" 
                          className="form-control" 
                          ...
                          min="1" 
                          max="31"
                          onChange={(e) => handleInputChange('diaVencimiento', Number(e.target.value))}
                        />
                        <span className="input-group-text">del mes</span>
                      </div>
                      <div className="form-text">Día en que vence el pago de gastos comunes</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-3">
                  <div className="form-check form-switch">
                    <input 
                      ...
                      onChange={(e) => handleInputChange('notificacionesAuto', e.target.checked)}
                    />
                    <label className="form-check-label" htmlFor="notificacionesAuto">
                      ...
                      <div className="mb-2">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={(e) => handleInputChange('notificacion3Dias', e.target.checked)}
                          />
                          <label className="form-check-label" htmlFor="notificacion3Dias">
                      ...
                      <div className="mb-2">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={(e) => handleInputChange('notificacion1Dia', e.target.checked)}
                          />
                          <label className="form-check-label" htmlFor="notificacion1Dia">
                      ...
                      <div className="mb-2">
                        <div className="form-check">
                          <input 
                            ...
                            onChange={(e) => handleInputChange('notificacionVencido', e.target.checked)}
                          />
                          <label className="form-check-label" htmlFor="notificacionVencido">
            ...
            <div className="param-section">
              <div className="param-header">
                <h4 className="mb-0">
                  <span className="material-icons align-middle me-2">credit_card</span> 
                  Medios de Pago
                </h4>
              </div>
              <div className="param-body">
                    ...
                    <div className="mb-3">
                      <div className="form-check form-switch mb-3">
                        <input 
                          ...
                          onChange={(e) => handleInputChange('pagoTransferencia', e.target.checked)}
                        />
                      ...
                      {parametros.pagoTransferencia && parametros.cuentaBancaria && (
                        <div className="card mb-3 ms-4">
                          <div className="card-body">
                            <div className="mb-3">
                              <label htmlFor="bancoCuenta" className="form-label">Banco</label>
                              <select 
                                className="form-select" 
                                id="bancoCuenta"
                            ...
                            <div className="mb-3">
                              ...
                              <select 
                                ...
                                onChange={(e) => handleCuentaBancariaChange('tipoCuenta', e.target.value as 'corriente' | 'vista' | 'ahorro')}
                              >
                            ...
                            <div className="mb-3">
                              ...
                              <input 
                                ...
                                onChange={(e) => handleCuentaBancariaChange('numeroCuenta', e.target.value)}
                              />
                            </div>
                            <div className="mb-3">
                              <label htmlFor="rutTitular" className="form-label">RUT titular</label>
                              <input 
                                type="text" 
                                className="form-control" 
                                id="rutTitular" 
                                value={parametros.cuentaBancaria.rutTitular}
                                onChange={(e) => handleCuentaBancariaChange('rutTitular', e.target.value)}
                              />
                            </div>
                            <div className="mb-3">
                              <label htmlFor="emailConfirmacion" className="form-label">Email para confirmaciones</label>
                              <input 
                                type="email" 
                                className="form-control" 
                                id="emailConfirmacion" 
                                value={parametros.cuentaBancaria.emailConfirmacion}
                                onChange={(e) => handleCuentaBancariaChange('emailConfirmacion', e.target.value)}
                              />
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="mb-3">
                      <div className="form-check form-switch mb-3">
                        <input 
                          ...
                          onChange={(e) => handleInputChange('pagoWebpay', e.target.checked)}
                        />
                        <label className="form-check-label" htmlFor="pagoWebpay">
                          Webpay / Transbank
                        </label>
                      </div>
                      ...
                      {parametros.pagoWebpay && (
                        <div className="card mb-3 ms-4">
                          <div className="card-body">
                            <p className="text-muted">La integración con Webpay está activada y configurada.</p>
                            <button type="button" className="btn btn-sm btn-outline-primary">Editar configuración</button>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="mb-3">
                      <div className="form-check form-switch mb-3">
                        <input 
                          ...
                          onChange={(e) => handleInputChange('pagoKhipu', e.target.checked)}
                        />
                      ...
                      {parametros.pagoKhipu && (
                        <div className="card mb-3 ms-4">
                          <div className="card-body">
                            <p className="text-muted">La integración con Khipu no está configurada.</p>
                            <button type="button" className="btn btn-sm btn-outline-primary">Configurar integración</button>
                          </div>
                        </div>
                      )}
                    </div>
                    ...
                    <div className="mb-3">
                      <div className="form-check form-switch">
                        <input 
                          ...
                          onChange={(e) => handleInputChange('pagoEfectivo', e.target.checked)}
                        />
            ...
            <div className="param-section">
              <div className="param-header">
                <h4 className="mb-0">
                  <span className="material-icons align-middle me-2">gavel</span> 
                  Multas
                </h4>
              </div>
              <div className="param-body">
                    ...
                    <tbody>
                      {multas.map((multa) => (
                        <tr key={multa.id}>
                          ...
                          <td>
                            <span className={`badge ${multa.activa ? 'bg-success' : 'bg-secondary'}`}>
                              {multa.activa ? 'Sí' : 'No'}
                            </span>
                          </td>
                          <td>
                ...
                <button type="button" className="btn btn-sm btn-primary">
                  <span className="material-icons align-middle me-1">add</span> Agregar multa
                </button>
              </div>
            </div>
                  ...
                  {historialEjemplo.map((item) => (
                    <div key={item.id} className="history-item">
                      ...
                      <div className="history-detail">
                        <span className="text-muted">Usuario:</span> {item.usuario}<br />
                        <span className="text-muted">Cambios:</span> {item.detalles}
                      </div>
                    </div>
                  ))}
                </div>
