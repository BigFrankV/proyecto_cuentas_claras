...
import { CategoryBadge, AccessBadge, FileIcon, VersionBadge, DocumentCard } from '@/components/documentos';
...
export default function DocumentosListado() {
    ...
    const mockDocuments: Document[] = [
      {
        ...
        description: 'Documento oficial con las normas y reglamentos de la copropiedad',
        category: 'legal',
        access: 'public',
      ...
      },
      {
        ...
        description: 'Guía técnica para el mantenimiento de los ascensores del edificio',
        category: 'technical',
        access: 'admin',
  ...
  const handleBulkAction = (action: string) => {
    ...
    switch (action) {
      case 'download':
        ...
        break;
      case 'delete':
        if (confirm(`¿Estás seguro de que deseas eliminar ${selectedDocuments.length} documentos?`)) {
        ...
        break;
      case 'export':
        alert(`Exportando información de ${selectedDocuments.length} documentos`);
        break;
    }
  };
  ...
  const categories = [
    { id: 'all', name: 'Todas las categorías', icon: 'folder', count: documents.length },
    { id: 'legal', name: 'Legal', icon: 'gavel', count: documents.filter(d => d.category === 'legal').length },
    { id: 'financial', name: 'Financiero', icon: 'attach_money', count: documents.filter(d => d.category === 'financial').length },
    { id: 'technical', name: 'Técnico', icon: 'build', count: documents.filter(d => d.category === 'technical').length },
    { id: 'administrative', name: 'Administrativo', icon: 'business', count: documents.filter(d => d.category === 'administrative').length },
    { id: 'maintenance', name: 'Mantenimiento', icon: 'handyman', count: documents.filter(d => d.category === 'maintenance').length },
    { id: 'meeting', name: 'Reuniones', icon: 'groups', count: documents.filter(d => d.category === 'meeting').length }
  ];
        ...
        <div className='container-fluid p-4'>
              ...
              <div className='d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-4 gap-3'>
                <div>
                  ...
                  <p className='text-muted mb-0'>Gestiona todos los documentos de la copropiedad</p>
                </div>
                <div className='d-flex gap-2'>
                  <Link href='/documentos/nuevo' className='btn btn-outline-primary'>
                ...
                <div className='col-sm-6 col-lg-3'>
                  <div className='stats-card card border-0 shadow-sm h-100'>
                    <div className='card-body d-flex align-items-center'>
                      ...
                      <div>
                        <div className='stats-number h4 mb-0'>{documents.filter(d => d.access === 'public').length}</div>
                ...
                <div className='col-sm-6 col-lg-3'>
                  <div className='stats-card card border-0 shadow-sm h-100'>
                    <div className='card-body d-flex align-items-center'>
                      ...
                      <div>
                        <div className='stats-number h4 mb-0'>{documents.filter(d => d.access === 'owners').length}</div>
                        <div className='stats-label text-muted small'>Solo Propietarios</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className='col-sm-6 col-lg-3'>
                  <div className='stats-card card border-0 shadow-sm h-100'>
                    <div className='card-body d-flex align-items-center'>
                      ...
                      <div>
                        <div className='stats-number h4 mb-0'>{documents.filter(d => d.isLatest).length}</div>
                        <div className='stats-label text-muted small'>Versiones Actuales</div>
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            <td>
                              <div className='d-flex align-items-center'>
                                ...
                                <div className='ms-3'>
                                  ...
                                  <div className='text-muted small'>{document.fileName} ({document.fileSize})</div>
                                </div>
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <div className='dropdown'>
                                ...
                                <ul className='dropdown-menu dropdown-menu-end'>
                                  ...
                                  <li>
                                    <button className='dropdown-item' onClick={() => handleDocumentAction('download', document.id)}>
              ...
              {filteredDocuments.length === 0 && (
                <div className='text-center py-5'>
                  ...
                  <p className='text-muted'>
                    {searchTerm ? 'Intenta cambiar los filtros de búsqueda' : 'Comienza subiendo tu primer documento'}
                  </p>
                  {!searchTerm && (
