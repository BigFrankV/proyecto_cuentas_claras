        ...
        <div className='container-fluid py-4'>
          ...
          <nav aria-label="breadcrumb" className="mb-4">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page">Nueva Torre</li>
            </ol>
          </nav>
            ...
            <div className="row">
              <div className="col-lg-8">
                ...
                <div className="card mb-4">
                  <div className="card-header" style={{ backgroundColor: '#f9f9f9' }}>
                  ...
                  <div className="card-body">
                    <div className="mb-3">
                      ...
                      {errors.edificioId && <div className="invalid-feedback">{errors.edificioId}</div>}
                      <div className="form-text">Edificio al que pertenece esta torre</div>
                    </div>
                      ...
                      <div className="col-md-8">
                        <div className="mb-3">
                          <label htmlFor="nombreTorre" className="form-label">
                            Nombre de la Torre <span className="text-danger">*</span>
                          </label>
                          <input 
                            type="text" 
                    ...
                    <div className="mb-3">
                      <label htmlFor="descripcionTorre" className="form-label">Descripción</label>
                      <textarea 
                  ...
                  <div className="card-body">
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="numPisos" className="form-label">Número de Pisos</label>
                          <input 
                            type="number" 
                          ...
                          />
                          {errors.numPisos && <div className="invalid-feedback">{errors.numPisos}</div>}
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="numUnidades" className="form-label">Número de Unidades</label>
                          <input 
                            type="number" 
                            ...
                            onChange={(e) => handleInputChange('numUnidades', parseInt(e.target.value) || 1)}
                          />
                          {errors.numUnidades && <div className="invalid-feedback">{errors.numUnidades}</div>}
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="administradorTorre" className="form-label">Administrador</label>
                          <select 
                            className="form-select" 
                            id="administradorTorre"
                            value={formData.administradorId}
                            onChange={(e) => handleInputChange('administradorId', e.target.value)}
                          >
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label className="form-label">Servicios Específicos</label>
                          <div className="form-check">
                            <input 
                              ...
                              onChange={(e) => handleInputChange('tieneAscensor', e.target.checked)}
                            />
                            <label className="form-check-label" htmlFor="tieneAscensor">
                              Ascensor
                            </label>
                          </div>
                          <div className="form-check">
                            <input 
                              ...
                              onChange={(e) => handleInputChange('tienePorteria', e.target.checked)}
                            />
                            <label className="form-check-label" htmlFor="tienePorteria">
                              Portería
                            </label>
                          </div>
                          <div className="form-check">
                            <input 
                              ...
                              onChange={(e) => handleInputChange('tieneEstacionamiento', e.target.checked)}
                            />
                            <label className="form-check-label" htmlFor="tieneEstacionamiento">
                ...
                <div className="card mb-4">
                  ...
                  <div className="card-body">
                    <div className="mb-3">
                      <label className="form-label d-block">¿Tiene gastos específicos por torre?</label>
                      <div className="form-check form-check-inline">
                        <input 
                          ...
                          onChange={(e) => handleInputChange('gastosEspecificos', e.target.value as 'si' | 'no')}
                        />
                        <label className="form-check-label" htmlFor="gastosNo">No</label>
                      </div>
                      <div className="form-check form-check-inline">
                        <input 
                          className="form-check-input" 
                          ...
                          onChange={(e) => handleInputChange('gastosEspecificos', e.target.value as 'si' | 'no')}
                        />
                        <label className="form-check-label" htmlFor="gastosSi">Sí</label>
                      </div>
                      <div className="form-text">Si la torre tiene gastos separados del resto del edificio</div>
                    </div>
                    
                    <div className="mb-3">
                      <label htmlFor="coeficienteTorre" className="form-label">Coeficiente de Torre</label>
                      <div className="input-group">
                        <input 
                          ...
                          onChange={(e) => handleInputChange('coeficienteTorre', parseFloat(e.target.value) || 0)}
                          required={formData.gastosEspecificos === 'si'}
                        />
                        <span className="input-group-text">%</span>
                        {errors.coeficienteTorre && <div className="invalid-feedback">{errors.coeficienteTorre}</div>}
                      </div>
                      <div className="form-text">Coeficiente de participación de la torre en el edificio</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-4">
                ...
                <div className="card mb-4">
                  ...
                  <div className="card-body">
                    <div className="mb-4">
                      <label className="form-label">Imagen Representativa</label>
                      <div 
                        ...
                        onMouseEnter={(e) => {
                          if (!imagePreview) e.currentTarget.style.borderColor = 'var(--color-primary)';
                        }}
                        onMouseLeave={(e) => {
                          if (!imagePreview) e.currentTarget.style.borderColor = '#ddd';
                        }}
                      >
                        {imagePreview ? (
                          <img 
                          ...
                          <>
                            <i className="material-icons mb-2" style={{ fontSize: '48px', color: '#aaa' }}>
                              add_photo_alternate
                            </i>
                            <p className="mb-1">Arrastrar imagen o hacer clic para subir</p>
                            <p className="small text-muted mb-0">PNG, JPG hasta 5MB</p>
                          </>
                        )}
                      </div>
                      <input 
                      ...
                      />
                      {errors.imagen && <div className="text-danger small mt-1">{errors.imagen}</div>}
                    </div>
                  </div>
                </div>
                ...
                <div className="card mb-4">
                  ...
                  <div className="card-body">
                    <div className="form-check form-switch mb-3">
                      ...
                      />
                      <label className="form-check-label" htmlFor="torreActiva">Torre Activa</label>
                    </div>
                    <div className="form-check form-switch mb-3">
                      <input 
                        className="form-check-input" 
                        ...
                        onChange={(e) => handleInputChange('visibleEnPortal', e.target.checked)}
                      />
                      <label className="form-check-label" htmlFor="visibleEnPortal">Visible en portal público</label>
                    </div>
                    <div className="form-check form-switch mb-3">
                      <input 
                        className="form-check-input" 
                        ...
                        onChange={(e) => handleInputChange('facturacionIndependiente', e.target.checked)}
                      />
                      <label className="form-check-label" htmlFor="facturacionIndependiente">
                        Facturación independiente
                      </label>
                      <div className="form-text">La torre gestiona sus gastos de forma independiente</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="card mb-4">
                  ...
                  <div className="card-body">
                    <div className="mb-3">
                      <label htmlFor="observaciones" className="form-label">Notas adicionales</label>
                      <textarea 
                        className="form-control" 
                        id="observaciones" 
                        rows={4}
