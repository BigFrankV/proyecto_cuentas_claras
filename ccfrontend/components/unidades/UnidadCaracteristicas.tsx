...
const UnidadCaracteristicas: React.FC<UnidadCaracteristicasProps> = ({
  ...
  const caracteristicas: CaracteristicaOption[] = [
    ...
    {
      id: 'vista_cordillera',
      nombre: 'Vista a la Cordillera',
      categoria: 'Ubicación',
      icono: 'landscape',
    },
    {
      id: 'cerca_metro',
      nombre: 'Cerca del Metro',
      categoria: 'Ubicación',
      icono: 'train',
    },
    {
      id: 'centro_comercial',
      nombre: 'Centro Comercial Cercano',
      categoria: 'Ubicación',
      icono: 'shopping_cart',
    },
        ...
        {selectedCaracteristicas.length > 0 && (
          <div className='alert alert-info py-2 mb-3'>
            <small>
              ...
              {selectedCaracteristicas.length} característica
              {selectedCaracteristicas.length !== 1 ? 's' : ''} seleccionada
              {selectedCaracteristicas.length !== 1 ? 's' : ''}
            </small>
          </div>
        )}
