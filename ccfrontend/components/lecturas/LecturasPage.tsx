        ...
        <header className="bg-white border-bottom shadow-sm p-3">
          <div className="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center gap-2">
              <input id="meterSearch" className="form-control form-control-sm" placeholder="Buscar medidor..." style={{ width: 220 }} />
            </div>
          </div>
        </header>
              ...
              <div className="reading-form-card">
                ...
                <form id="readingForm">
                  ...
                  <div className="mb-3">
                    ...
                    <input id="readingDate" type="datetime-local" className="form-control" />
                  </div>
                  <div className="mb-3">
                    <label className="form-label">Lectura actual</label>
                    <input id="currentReading" type="number" className="form-control reading-input" defaultValue={0} />
                  </div>
                  <div className="d-grid gap-2">
                    <button type="submit" className="btn btn-primary">Guardar lectura</button>
                    <button type="button" className="btn btn-outline-secondary" onClick={() => window.location.reload()}>Limpiar</button>
                  </div>
                </form>
              </div>
            ...
            <div className="col-lg-8">
              <div className="reading-history">
                <div className="reading-history-header d-flex justify-content-between align-items-center p-3">
                  ...
                  <div>
                    <button className="btn btn-sm btn-outline-secondary me-2">Exportar</button>
                    <button className="btn btn-sm btn-primary">Agregar lectura masiva</button>
                  </div>
                </div>
                <div className="p-3">
