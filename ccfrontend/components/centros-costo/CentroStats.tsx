...
export default function CentroStats({ total, active, presupuestoTotal = 0, ejecutado = 0 }: StatsProps) {
  const fmt = (v: number) =>
    isFinite(v) && !Number.isNaN(v) ? v.toLocaleString('es-CL', { style: 'currency', currency: 'CLP', maximumFractionDigits: 0 }) : '$0';
