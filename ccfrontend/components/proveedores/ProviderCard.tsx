            ...
            <Card.Body>
              <div className="d-flex justify-content-between">
                <div>
                  ...
                  <Card.Subtitle className="text-muted">{p.comunidad_nombre}</Card.Subtitle>
                </div>
                <div className="text-end">
                  {p.activo === 1 ? <span className="badge bg-success">Activo</span> : <span className="badge bg-secondary">Inactivo</span>}
                </div>
              </div>
