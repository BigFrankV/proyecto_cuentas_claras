...
export default function ProviderStats({ total, active, totalGastos = 0, montoTotal = 0 }: ProviderStatsProps) {
  const fmt = (v: number) => v ? v.toLocaleString('es-CL', { style: 'currency', currency: 'CLP', maximumFractionDigits: 0 }) : '$0';
  return (
