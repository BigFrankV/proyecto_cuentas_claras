    ...
    <div className='col-md-6 col-lg-4 col-xl-3'>
      <div className='card comunidad-card app-card h-100'>
        ...
        <div className='position-relative'>
          ...
          {/* Badge de estado */}
          <span
            className={`badge position-absolute top-0 end-0 m-2 ${comunidadesService.getEstadoBadgeClass(comunidad.estado)}`}
          >
            {comunidad.estado}
          </span>
        ...
        <div className='card-body d-flex flex-column'>
          ...
          <div className='row g-2 mb-3'>
            ...
            <div className='col-4'>
              <div className='text-center'>
                <div
                  className={`h6 mb-0 ${morosidadPorcentaje > 15 ? 'text-danger' : morosidadPorcentaje > 5 ? 'text-warning' : 'text-success'}`}
                >
          ...
          {saldoPendiente > 0 && (
            ...
            >
              ...
              {(saldoPendiente / 1000000).toFixed(1)}M
            </div>
          )}
