...
export default function DocumentoDetalle() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      const mockVersions: DocumentVersion[] = id === '1' ? [
        {
          id: '3',
          version: '2.1',
          uploadedBy: 'Admin',
          ...
          isLatest: true,
          changes: 'Actualización de normas de convivencia y uso de espacios comunes'
        },
        {
          id: '2',
          version: '2.0',
      ...
      const mockComments: Comment[] = [
        {
          ...
          user: 'Juan Pérez',
          avatar: 'JP',
          content: 'Documento muy útil. ¿Cuándo estará disponible la próxima actualización?',
              ...
              <div className='row align-items-center'>
                <div className='col-lg-8'>
                  <div className='d-flex align-items-center mb-3'>
                    ...
                    <div className='ms-3'>
                      <div className='d-flex align-items-center gap-2 mb-2'>
                        ...
                        <VersionBadge version={document.version} isLatest={document.isLatest} size='md' />
                      </div>
                  ...
                  <div className='document-meta row text-muted'>
                    <div className='col-md-6'>
                      <p className='mb-1'>
                        <i className='material-icons me-2' style={{ fontSize: '16px' }}>insert_drive_file</i>
                    ...
                    <div className='col-md-6'>
                      <p className='mb-1'>
                        <i className='material-icons me-2' style={{ fontSize: '16px' }}>download</i>
                ...
                <div className='col-lg-4 text-lg-end'>
                  <div className='d-flex flex-column gap-2'>
                    ...
                    <Link href={`/documentos/${document.id}/editar`} className='btn btn-outline-secondary'>
                ...
                <div className='card shadow-sm mb-4'>
                  <div className='card-body'>
                    ...
                    <div className='document-preview bg-light rounded p-4 text-center'>
                      ...
                      <p className='text-muted mb-3'>Tamaño: {document.fileSize}</p>
                      <button className='btn btn-primary' onClick={handleDownload}>
                  ...
                  <div className='card-body'>
                    ...
                    <div className='versions-list'>
                      {versions.map((version) => (
                        <div key={version.id} className='version-item d-flex align-items-start p-3 border rounded mb-3'>
                          <div className='version-icon me-3'>
                            <VersionBadge version={version.version} isLatest={version.isLatest} size='md' />
                          </div>
                          <div className='version-content flex-grow-1'>
                            <div className='version-header d-flex justify-content-between align-items-start mb-2'>
                              <div>
                                <h6 className='version-title mb-1'>Versión {version.version}</h6>
                                {version.changes && (
                                  <p className='version-changes text-muted mb-0'>{version.changes}</p>
                                )}
                              </div>
                    ...
                    {comments.length > 0 ? (
                      <div className='comments-list'>
                        {comments.map((comment) => (
                          <div key={comment.id} className='comment-item d-flex mb-4'>
                ...
                <div className='card-body'>
                  ...
                  <div className='stats-list'>
                    <div className='stat-item d-flex justify-content-between mb-2'>
                      ...
                      <span className='fw-medium'>{document.downloadCount || 0}</span>
                    </div>
                    <div className='stat-item d-flex justify-content-between mb-2'>
                  ...
                  <div className='related-docs'>
                    <div className='related-doc-item d-flex align-items-center mb-3'>
                      ...
                      <div className='ms-2 flex-grow-1'>
                        <div className='related-doc-name small fw-medium'>Manual de Convivencia</div>
                        <div className='related-doc-category text-muted small'>Legal</div>
                      </div>
                    </div>
                    <div className='related-doc-item d-flex align-items-center'>
                      <FileIcon fileName='estatutos.pdf' size='sm' />
                      <div className='ms-2 flex-grow-1'>
                        <div className='related-doc-name small fw-medium'>Estatutos de la Copropiedad</div>
                        <div className='related-doc-category text-muted small'>Legal</div>
                      </div>
                    </div>
                  </div>
