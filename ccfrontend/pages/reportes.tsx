...
export default function ReportesDashboard() {
  ...
  const renderFinancialReport = () => {
    ...
    const flujoData =
      flujoCaja && flujoCaja.length > 0 ? flujoCaja : reportData;
          ...
          <div className='card app-card shadow-sm h-100'>
            <div className='card-body'>
              ...
              <div className='h4 mb-0'>
                {consumosResumen?.total ? consumosResumen.total : '—'}
              </div>
            </div>
          </div>
        </div>
          ...
          {accesosVisitas && accesosVisitas.length > 0 ? (
            <div>
              <div className='small text-muted mb-2'>
                Total visitas: {accesosVisitas.length}
              </div>
              <div className='table-responsive'>
                <table className='table table-sm'>
                  <thead>
              ...
              <div className='position-relative' style={{ minWidth: '280px' }}>
                <div className='input-group'>
                  ...
                  <input
                    ...
                    onBlur={() =>
                      setTimeout(() => setShowCommunityList(false), 200)
                    }
                  />
                </div>
              ...
              {selectedCommunity && (
                <div className='filter-badge me-2'>
                  ...
                  <span
                    ...
                    onKeyDown={e =>
                      e.key === 'Enter' && setSelectedCommunity(null)
                    }
                    role='button'
                    tabIndex={0}
                  >
