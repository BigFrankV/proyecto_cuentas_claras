  ...
  const loadInitialData = async () => {
    try {
      ...
      const mockCostCenters: CostCenter[] = [
        { id: 1, name: 'Mantenimiento General', department: 'maintenance', budget: 3500000, spent: 1200000 },
        { id: 2, name: 'Servicios Generales', department: 'operations', budget: 2800000, spent: 850000 },
        { id: 3, name: 'Administración', department: 'administration', budget: 2100000, spent: 650000 },
        { id: 4, name: 'Jardinería y Paisajismo', department: 'operations', budget: 1500000, spent: 320000 },
        { id: 5, name: 'Seguridad', department: 'security', budget: 4200000, spent: 1800000 }
      ];
                ...
                <Card className="purchase-form-section mb-4">
                  ...
                  <Card.Body>
                    <Row className="g-3">
                      <Col xs={12}>
                        <Form.Group>
                          <Form.Label className="required">Proveedor Seleccionado</Form.Label>
                          <Form.Select
                          ...
                          <div className="provider-selected-info">
                            <div className="d-flex align-items-center">
                              <div className="provider-logo me-3">
                                {getSelectedProvider()!.name.substring(0, 2).toUpperCase()}
                              </div>
                              <div>
                                <h6 className="mb-1">{getSelectedProvider()!.name}</h6>
                        ...
                        <Col xs={12}>
                          <div className="budget-info">
                            <div className="d-flex justify-content-between align-items-center">
                              ...
                              <strong>
                                {formatCurrency(
                                  getSelectedCostCenter()!.budget - getSelectedCostCenter()!.spent, 
                                  formData.currency
                                )}
                              </strong>
                            </div>
                  ...
                  <Card.Body>
                    ...
                    {getSelectedProvider() && (
                      <div className="mt-3 pt-3 border-top">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <div className="fw-medium">{getSelectedProvider()!.name}</div>
                            <small className="text-muted">⭐ {getSelectedProvider()!.rating}</small>
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    {getSelectedCostCenter() && (
                      <div className="mt-3 pt-3 border-top">
                        ...
                        <div className="fw-medium">{getSelectedCostCenter()!.name}</div>
                        <small className="text-muted">{getSelectedCostCenter()!.department}</small>
                      </div>
                    )}
                  </Card.Body>
                </Card>
                    ...
                    <div className="info-list">
                      <div className="info-item">
                        ...
                        <div>
                          ...
                          <p>Las compras superiores a $10,000 requieren aprobación del administrador.</p>
                        </div>
                      </div>
                      <div className="info-item">
                        ...
                        <div>
                          ...
                          <p>El tiempo estimado de procesamiento es de 2-5 días hábiles.</p>
                        </div>
                      </div>
                      <div className="info-item">
                        ...
                        <div>
                          ...
                          <p>Asegúrate de adjuntar cotizaciones y documentos de respaldo.</p>
                        </div>
                      </div>
                    </div>
                  </Card.Body>
                ...
                >
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-grow-1">
                      ...
                      <small className="text-muted">
                        {provider.category} • ⭐ {provider.rating} • {provider.status}
                      </small>
                    </div>
