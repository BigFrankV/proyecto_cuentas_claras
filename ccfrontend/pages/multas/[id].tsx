...
const MultaDetalleRoute: React.FC = () => {
  ...
  if (loading) return <Layout title="Cargando..." noGutter><div className="p-4">Cargando...</div></Layout>;
  if (!multa) return <Layout title="Multa no encontrada"><div className="p-4">Multa no encontrada</div></Layout>;
