...
export default function CategoriasGastoListado() {
  ...
  // Resolver comunidad (usar selector global, si no usar user.comunidad_id). Mantener global para superusers
  ...
  const loadCategories = useCallback(async (page = 1) => {
    try {
      ...
      // eslint-disable-next-line no-console
      console.log('Response data:', categoriesData); // <-- añadir
      ...
      // eslint-disable-next-line no-console
      console.log('Categories set:', categoriesData); // <-- añadir
    } catch (error) {
      // eslint-disable-next-line no-console
  ...
  }, [authLoading, isAuthenticated, loadCategories, resolvedComunidadId]);
              ...
              <div className='col-12 col-md-8'>
                <div className='card shadow-sm'>
                  <div className='card-body text-center p-5'>
                    ...
                    <p className='text-muted'>No tienes permisos para ver Categorías de Gasto en la comunidad seleccionada. Solo usuarios con roles administrativos pueden acceder a esta sección.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className='p-4'>
                ...
                <div className='d-flex align-items-center justify-content-between'>
                  ...
                  {hasPermission(Permission.CREATE_CATEGORIA_GASTO, resolvedComunidadId) && (
                        ...
                        <tr key={category.id} className='data-row'>
                          ...
                          <td className='text-end'>
                            <div className='d-flex gap-1 justify-content-end'>
                              {hasPermission(Permission.EDIT_CATEGORIA_GASTO, resolvedComunidadId) && (
                                <Button
                              ...
                              {hasPermission(Permission.DELETE_CATEGORIA_GASTO, resolvedComunidadId) && (
                                <Button
