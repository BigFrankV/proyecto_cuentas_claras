...
export default function DocumentoCompraDetalle() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const mockDocument: PurchaseDocumentDetail = {
        ...
        dueDate: '2024-02-15',
        items: [
          { id: '1', description: 'Mantenimiento preventivo ascensor 1', quantity: 1, unitPrice: 250000, total: 250000 },
          { id: '2', description: 'Mantenimiento preventivo ascensor 2', quantity: 1, unitPrice: 250000, total: 250000 },
          { id: '3', description: 'Repuestos varios', quantity: 5, unitPrice: 50000, total: 250000 },
          { id: '4', description: 'Mano de obra técnica especializada', quantity: 8, unitPrice: 25000, total: 200000 }
        ],
        subtotal: 950000,
        taxRate: 19,
        taxAmount: 180500,
        total: 1130500,
        attachments: [
          { id: '1', name: 'factura-fc-2024-001.pdf', size: '2.1 MB', type: 'pdf', url: '#' },
          { id: '2', name: 'orden-trabajo-ascensores.docx', size: '156 KB', type: 'doc', url: '#' }
        ],
        createdBy: 'Admin',
        ...
        comments: [
          {
            ...
            user: 'Revisor',
            avatar: 'RE',
            content: 'Los montos parecen estar correctos. Revisar la fecha de vencimiento.',
            date: '2024-01-16T09:15:00Z'
          }
        ],
        notes: 'Mantenimiento programado según contrato anual. Incluye revisión completa de sistemas.',
  ...
  const handleApproval = (action: 'approve' | 'reject') => {
    ...
    alert(`Documento ${action === 'approve' ? 'aprobado' : 'rechazado'} exitosamente`);
  };
        ...
        <Layout title='Documento no encontrado'>
          <div className='container-fluid py-4'>
            <div className='text-center'>
              ...
              <p className='text-muted'>El documento que buscas no existe o ha sido eliminado.</p>
          ...
          <nav aria-label='breadcrumb' className='mb-4'>
            <ol className='breadcrumb'>
              <li className='breadcrumb-item'>
                <Link href='/documentos-compra' className='text-decoration-none'>
            ...
            <div className='card-body'>
              <div className='row align-items-center'>
                  ...
                  <div className='document-info text-muted'>
                    <div className='row'>
                      <div className='col-md-6'>
                        <p className='mb-1'>
                          <i className='material-icons me-2' style={{ fontSize: '16px' }}>business</i>
                          {document.provider.name}
                        </p>
                        <p className='mb-1'>
                          <i className='material-icons me-2' style={{ fontSize: '16px' }}>calendar_today</i>
                          Fecha: {new Date(document.date).toLocaleDateString('es-CL')}
                        </p>
                        {document.dueDate && (
                          <p className='mb-1'>
                            <i className='material-icons me-2' style={{ fontSize: '16px' }}>schedule</i>
                            Vencimiento: {new Date(document.dueDate).toLocaleDateString('es-CL')}
                          </p>
                        )}
                      </div>
                      <div className='col-md-6'>
                        <p className='mb-1'>
                          <i className='material-icons me-2' style={{ fontSize: '16px' }}>person</i>
                          Creado por: {document.createdBy}
                        </p>
                        <p className='mb-1'>
                          <i className='material-icons me-2' style={{ fontSize: '16px' }}>access_time</i>
                          {formatDate(document.createdAt)}
                        </p>
                        {document.costCenter && (
                          <p className='mb-1'>
                            <i className='material-icons me-2' style={{ fontSize: '16px' }}>account_tree</i>
                ...
                <div className='col-lg-4 text-lg-end'>
                  <div className='h2 text-primary mb-3'>{formatCurrency(document.total)}</div>
                  <div className='d-flex gap-2 justify-content-lg-end'>
                    ...
                    <div className='dropdown'>
                      ...
                      <ul className='dropdown-menu dropdown-menu-end'>
                        <li>
                          <Link className='dropdown-item' href={`/documentos-compra/${document.id}/editar`}>
                          ...
                          <div className='timeline-content'>
                            <div className='timeline-header d-flex justify-content-between align-items-start mb-2'>
                              <div>
                                ...
                                <p className='timeline-description text-muted mb-0'>{event.description}</p>
                              </div>
                  ...
                  <div className='card-body'>
                    ...
                    {document.attachments.length > 0 ? (
                          ...
                          <div key={attachment.id} className='col-md-6'>
                            <div className='attachment-item d-flex align-items-center p-3 border rounded'>
                              ...
                              <div className='attachment-info flex-grow-1 ms-3'>
                                ...
                                <div className='attachment-meta text-muted small'>{attachment.size}</div>
                              </div>
                      ...
                      <div className='text-center py-4'>
                        <i className='material-icons mb-2 text-muted' style={{ fontSize: '3rem' }}>
                          attach_file
                        </i>
                  ...
                  <div className='card-body'>
                        ...
                        {document.comments.map((comment) => (
                          <div key={comment.id} className='comment-item d-flex mb-3'>
                            <div className='avatar bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-3'
                                 style={{ width: '40px', height: '40px', fontSize: '14px', fontWeight: '500' }}>
                              {comment.avatar}
                            </div>
                            <div className='comment-content flex-grow-1'>
                              <div className='comment-header d-flex justify-content-between align-items-center mb-2'>
                                <div className='comment-author fw-medium'>{comment.user}</div>
                    ...
                    <div className='add-comment'>
                      ...
                      <div className='d-flex'>
                        <div className='avatar bg-secondary text-white rounded-circle d-flex align-items-center justify-content-center me-3'
                             style={{ width: '40px', height: '40px', fontSize: '14px', fontWeight: '500' }}>
                          UC
                        </div>
              ...
              <div className='provider-info-box card shadow-sm mb-4'>
                <div className='card-body'>
                  <div className='provider-header d-flex align-items-center mb-3'>
                    <div className='provider-logo bg-primary text-white rounded d-flex align-items-center justify-content-center me-3'
                         style={{ width: '48px', height: '48px', fontWeight: '500' }}>
                      {document.provider.name.substring(0, 2).toUpperCase()}
                    </div>
                    <div>
                      <div className='provider-name fw-bold'>{document.provider.name}</div>
                  ...
                  <div className='provider-details'>
                    <div className='provider-contact mb-2'>
                      ...
                      <a href={`mailto:${document.provider.email}`} className='text-decoration-none'>
                        {document.provider.email}
                      </a>
                    </div>
                    <div className='provider-contact mb-2'>
                      <i className='material-icons me-2'>phone</i>
                      <a href={`tel:${document.provider.phone}`} className='text-decoration-none'>
              ...
              <div className='card shadow-sm mb-4'>
                <div className='card-body'>
                  ...
                  <div className='detail-section'>
                    ...
                    <div className='detail-item d-flex justify-content-between mb-2'>
                      <span className='label text-muted'>Archivos adjuntos:</span>
                      <span className='value'>{document.attachments.length}</span>
                    </div>
                    <div className='detail-item d-flex justify-content-between mb-2'>
                    ...
                    {document.dueDate && (
                      <div className='detail-item d-flex justify-content-between'>
                        <span className='label text-muted'>Días para vencer:</span>
                        <span className='value'>
                          {Math.ceil((new Date(document.dueDate).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24))}
                        </span>
                      </div>
                    )}
                  </div>
                ...
                <div className='modal-content'>
                  <div className='modal-header'>
                    <h5 className='modal-title'>
                      {approvalAction === 'approve' ? 'Aprobar Documento' : 'Rechazar Documento'}
                    </h5>
                    <button
                      type='button'
                      className='btn-close'
                  ...
                  <div className='modal-body'>
                    <p>
                      ¿Estás seguro de que deseas {approvalAction === 'approve' ? 'aprobar' : 'rechazar'} este documento?
                    </p>
                    <div className='mb-3'>
