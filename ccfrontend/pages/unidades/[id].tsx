...
const mockUnidad: Unidad = {
  ...
  descripcion: 'Departamento de 3 dormitorios, 2 baños, luminoso, ubicado en primer piso.',
...
const mockHistorial: HistorialItem[] = [
  {
    ...
    descripcion: 'La propiedad fue transferida a Juan Ramírez (RUT: 12.345.678-9)'
  },
  {
    id: '2',
    fecha: '2021-01-10',
        ...
        <div className='container-fluid py-4'>
            ...
            <div className="col-md-6">
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active" aria-current="page">{unidad.numero}</li>
                </ol>
              </nav>
            </div>
            <div className="col-md-6 d-flex justify-content-end">
              <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <Link className="dropdown-item" href={`/unidades/${unidad.id}/tenencias`}>
                      <i className="material-icons align-middle me-1 small">person</i> 
                      Gestionar propietarios
                    </Link>
                  </li>
                  <li>
                    <Link className="dropdown-item" href={`/unidades/${unidad.id}/residentes`}>
                      <i className="material-icons align-middle me-1 small">people</i> 
                      Gestionar residentes
                    </Link>
                  </li>
                  <li>
                    <a className="dropdown-item" href="#">
                      <i className="material-icons align-middle me-1 small">receipt_long</i> 
                      Ver estado de cuenta
                    </a>
                  </li>
                  <li>
                    <a className="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#nuevoCargoPorUnidadModal">
                      <i className="material-icons align-middle me-1 small">receipt</i> 
                      Generar cargo
                    </a>
                  </li>
                  ...
                  <li>
                    <a className="dropdown-item text-danger" href="#">
                      <i className="material-icons align-middle me-1 small">delete</i> 
                      Eliminar unidad
                    </a>
                  </li>
                </ul>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <span className="badge bg-light text-dark">{unidad.superficie} m²</span>
                  </div>
                </div>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          >
                            {unidad.propietario.nombre.split(' ').map(n => n[0]).join('')}
                          </div>
                          <div>
                            <div className="fw-medium">{unidad.propietario.nombre}</div>
                            <div className="small text-muted">
                              Propietario desde {formatDate(unidad.propietario.fechaIngreso)}
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                          ...
                          {unidad.residentes.map((residente, index) => (
                            <div 
                              ...
                              style={{
                                ...
                                height: '32px',
                                borderRadius: '50%',
                                backgroundColor: index === 0 ? 'var(--color-primary)' : index === 1 ? 'var(--color-accent)' : 'var(--color-secondary)',
                                fontSize: '12px',
                        ...
                        >
                          <i className="material-icons align-middle me-1" style={{ fontSize: '16px' }}>people</i>
                          Gestionar residentes
                        </Link>
                      </div>
                    </div>
                    ...
                    <div className="col-md-6">
                      ...
                      {(unidad.estacionamiento || unidad.bodega) && (
                        <div className="mb-4">
                          <h6 className="text-muted mb-3">Bodega y Estacionamiento</h6>
                          {unidad.estacionamiento && (
                            <>
                              <div className="row mb-2">
                                <div className="col-md-6">
                                  <span className="text-muted">N° Estacionamiento:</span>
                                </div>
                                <div className="col-md-6">
                              ...
                              <div className="row mb-2">
                                <div className="col-md-6">
                                  <span className="text-muted">Ubicación Estacionamiento:</span>
                                </div>
                                <div className="col-md-6">
                          ...
                          {unidad.bodega && (
                            <>
                              ...
                              <div className="row mb-2">
                                <div className="col-md-6">
                                  <span className="text-muted">Ubicación Bodega:</span>
                                </div>
                                <div className="col-md-6">
          ...
          <div className="row mb-4">
            <div className="col-md-3 mb-3">
              ...
              >
                <div className="d-flex align-items-center mb-2">
                  <i className="material-icons me-2" style={{ color: 'var(--color-danger)' }}>account_balance</i>
            ...
            <div className="col-md-3 mb-3">
              ...
              >
                <div className="d-flex align-items-center mb-2">
                  <i className="material-icons me-2" style={{ color: 'var(--color-primary)' }}>payments</i>
                ...
                >
                  {unidad.ultimoPago ? formatCurrency(unidad.ultimoPago.monto) : 'N/A'}
                </div>
                {unidad.ultimoPago && (
                  <div className="small text-muted">{formatDateShort(unidad.ultimoPago.fecha)}</div>
                )}
              </div>
            </div>
            <div className="col-md-3 mb-3">
              ...
              >
                <div className="d-flex align-items-center mb-2">
                  <i className="material-icons me-2" style={{ color: 'var(--color-warning)' }}>water_drop</i>
            ...
            <div className="col-md-3 mb-3">
              ...
              >
                <div className="d-flex align-items-center mb-2">
                  <i className="material-icons me-2" style={{ color: 'var(--color-success)' }}>bolt</i>
              ...
              <ul className="nav nav-tabs" role="tablist">
                <li className="nav-item" role="presentation">
                  <button 
                    ...
                    role="tab"
                  >
                    <i className="material-icons align-middle me-1">receipt_long</i>
                    Cargos
                  </button>
                </li>
                <li className="nav-item" role="presentation">
                      ...
                      <tbody>
                        {cargos.map((cargo) => (
                          <tr key={cargo.id}>
                            ...
                            <td>
                              <span className={`badge ${getEstadoBadgeClass(cargo.estado)}`}>
                                {cargo.estado}
                              </span>
                            </td>
                            <td>
                      ...
                      <div className="col-md-6">
                        <div className="card mb-4">
                          <div className="card-header bg-white">
                            <h6 className="mb-0">
                              <i className="material-icons align-middle me-1" style={{ color: 'var(--color-warning)' }}>water_drop</i>
                              Medidor de Agua
                            </h6>
                          </div>
                          <div className="card-body">
                            <div className="row mb-3">
                              ...
                              <div className="col-md-8">{unidad.medidores.agua.codigo}</div>
                            </div>
                            <div className="row mb-3">
                              <div className="col-md-4 text-muted">Última lectura:</div>
                              <div className="col-md-8">
                                {unidad.medidores.agua.ultimaLectura} m³ ({formatDateShort(unidad.medidores.agua.fechaLectura)})
                              </div>
                            </div>
                            <div className="row mb-3">
                              <div className="col-md-4 text-muted">Consumo actual:</div>
                              <div className="col-md-8">{unidad.medidores.agua.consumoActual} m³</div>
                            </div>
                            <div className="row mb-3">
                              <div className="col-md-4 text-muted">Promedio mensual:</div>
                              <div className="col-md-8">{unidad.medidores.agua.promedioMensual} m³</div>
                            </div>
                    ...
                    {unidad.medidores.electricidad && (
                      <div className="col-md-6">
                        <div className="card mb-4">
                          <div className="card-header bg-white">
                            <h6 className="mb-0">
                              <i className="material-icons align-middle me-1" style={{ color: 'var(--color-success)' }}>bolt</i>
                          ...
                          <div className="card-body">
                            <div className="row mb-3">
                              <div className="col-md-4 text-muted">Código:</div>
                              <div className="col-md-8">{unidad.medidores.electricidad.codigo}</div>
                            </div>
                            <div className="row mb-3">
                              <div className="col-md-4 text-muted">Última lectura:</div>
                              <div className="col-md-8">
                                {unidad.medidores.electricidad.ultimaLectura} kWh ({formatDateShort(unidad.medidores.electricidad.fechaLectura)})
                              </div>
                            </div>
                            <div className="row mb-3">
                              <div className="col-md-4 text-muted">Consumo actual:</div>
                              <div className="col-md-8">{unidad.medidores.electricidad.consumoActual} kWh</div>
                            </div>
                            <div className="row mb-3">
                              <div className="col-md-4 text-muted">Promedio mensual:</div>
                              <div className="col-md-8">{unidad.medidores.electricidad.promedioMensual} kWh</div>
                            </div>
                            <button className="btn btn-sm btn-outline-primary mt-2">
                              <i className="material-icons align-middle me-1" style={{ fontSize: '16px' }}>add</i>
                              Nueva Lectura
                  ...
                  <div style={{ position: 'relative', paddingLeft: '30px' }}>
                    {historial.map((item, index) => (
                      <div 
                        ...
                        style={{ paddingBottom: index < historial.length - 1 ? '1.5rem' : '0' }}
                      >
                        <div
                        ...
                        <div className="text-muted">{formatDateShort(item.fecha)}</div>
