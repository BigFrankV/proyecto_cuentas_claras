...
export default function UnidadNueva() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.codigoUnidad) newErrors.codigoUnidad = 'El código de unidad es requerido';
    if (!formData.tipoUnidad) newErrors.tipoUnidad = 'El tipo de unidad es requerido';
    if (formData.m2Utiles <= 0) newErrors.m2Utiles = 'Los m² útiles deben ser mayor a 0';
        ...
        <div className='container-fluid py-4'>
          ...
          <nav aria-label="breadcrumb" className="mb-4">
            <ol className="breadcrumb">
              ...
              <li className="breadcrumb-item active" aria-current="page">Nueva Unidad</li>
            </ol>
          </nav>
            ...
            <div className="row">
              <div className="col-lg-8">
                  ...
                  <div className="p-4">
                    <div className="mb-3">
                      ...
                      <select 
                        ...
                        required
                      >
                        <option value="" disabled>Seleccionar comunidad</option>
                        {comunidades.map(comunidad => (
                          <option key={comunidad.id} value={comunidad.id}>{comunidad.nombre}</option>
                        ))}
                      </select>
                      {errors.comunidad && <div className="invalid-feedback">{errors.comunidad}</div>}
                    </div>
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          {errors.edificio && <div className="invalid-feedback">{errors.edificio}</div>}
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="torreSelect" className="form-label">Torre</label>
                          <select 
                          ...
                          >
                            <option value="">Seleccionar torre (opcional)</option>
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="codigoUnidad" className="form-label">
                            Código de Unidad <span className="text-danger">*</span>
                          </label>
                          <input 
                            type="text" 
                            ...
                            onChange={(e) => handleInputChange('codigoUnidad', e.target.value)}
                            required
                          />
                          <div className="form-text">Código único que identifica la unidad (Ej: A-101, 2B, Dpto. 503)</div>
                          {errors.codigoUnidad && <div className="invalid-feedback">{errors.codigoUnidad}</div>}
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="tipoUnidad" className="form-label">
                            Tipo de Unidad <span className="text-danger">*</span>
                          </label>
                          <select 
                            className="form-select" 
                            id="tipoUnidad"
                      ...
                      <div className="col-md-4">
                        <div className="mb-3">
                          ...
                          <input 
                            ...
                            min="0"
                            value={formData.piso}
                            onChange={(e) => handleInputChange('piso', parseInt(e.target.value) || 0)}
                          />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label htmlFor="nroDormitorios" className="form-label">N° Dormitorios</label>
                          <input 
                            type="number" 
                            className="form-control" 
                            id="nroDormitorios" 
                            ...
                            onChange={(e) => handleInputChange('nroDormitorios', parseInt(e.target.value) || 0)}
                          />
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label htmlFor="nroBanos" className="form-label">N° Baños</label>
                          <input 
                            type="number" 
                            className="form-control" 
                            id="nroBanos" 
                            ...
                            onChange={(e) => handleInputChange('nroBanos', parseInt(e.target.value) || 0)}
                          />
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="mb-3">
                      <label htmlFor="descripcionUnidad" className="form-label">Descripción</label>
                      <textarea 
                        className="form-control" 
                ...
                >
                  ...
                  <div className="p-4">
                    <div className="row">
                        ...
                        <div className="mb-3">
                          ...
                          <div className="input-group">
                            <input 
                              ...
                              onChange={(e) => handleInputChange('m2Utiles', parseFloat(e.target.value) || 0)}
                              required
                            />
                            <span className="input-group-text">m²</span>
                          </div>
                          {errors.m2Utiles && <div className="invalid-feedback">{errors.m2Utiles}</div>}
                        </div>
                      </div>
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label htmlFor="m2Terrazas" className="form-label">M² Terrazas</label>
                          <div className="input-group">
                            <input 
                              type="number" 
                              className="form-control" 
                              ...
                              onChange={(e) => handleInputChange('m2Terrazas', parseFloat(e.target.value) || 0)}
                            />
                            <span className="input-group-text">m²</span>
                          </div>
                        </div>
                      ...
                      <div className="col-md-4">
                        <div className="mb-3">
                          <label htmlFor="m2Totales" className="form-label">M² Totales</label>
                          <div className="input-group">
                            <input 
                              type="number" 
                              className="form-control" 
                      ...
                      <div className="col-md-6">
                        <div className="mb-3">
                          ...
                          <input 
                            ...
                            onChange={(e) => handleInputChange('alicuota', parseFloat(e.target.value) || 0)}
                          />
                          <div className="form-text">Valor decimal entre 0 y 1 (Ej: 0.012500)</div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="estadoInicial" className="form-label">Estado Inicial</label>
                          <select 
                            className="form-select" 
                            id="estadoInicial"
                            value={formData.estadoInicial}
                            onChange={(e) => handleInputChange('estadoInicial', e.target.value)}
                          >
                ...
                >
                  ...
                  <div className="p-4">
                    <div className="row">
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="estacionamiento" className="form-label">N° Estacionamiento</label>
                          <input 
                            type="text" 
                            className="form-control" 
                            id="estacionamiento"
                            ...
                            onChange={(e) => handleInputChange('estacionamiento', e.target.value)}
                          />
                        </div>
                        <div className="mb-3">
                          <label htmlFor="ubicacionEstacionamiento" className="form-label">Ubicación Estacionamiento</label>
                          <input 
                            type="text" 
                            className="form-control" 
                            ...
                            onChange={(e) => handleInputChange('ubicacionEstacionamiento', e.target.value)}
                          />
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="mb-3">
                          <label htmlFor="bodega" className="form-label">N° Bodega</label>
                          <input 
                            type="text" 
                            className="form-control" 
                            id="bodega"
                        ...
                        <div className="mb-3">
                          <label htmlFor="ubicacionBodega" className="form-label">Ubicación Bodega</label>
                          <input 
                            type="text" 
                            className="form-control" 
                            id="ubicacionBodega"
                ...
                >
                  ...
                  <div className="p-4">
                    <p className="text-muted mb-3">Seleccione las características que aplican a esta unidad:</p>
                    <div>
                ...
                >
                  ...
                  <div className="p-4">
                    {medidores.length === 0 ? (
                      <p className="text-muted mb-0">No hay medidores configurados. Haga clic en "Agregar Medidor" para añadir uno.</p>
                    ) : (
                      medidores.map((medidor) => (
                        <div key={medidor.id} className="border rounded p-3 mb-3">
                          <div className="row">
                            <div className="col-md-3">
                              ...
                              <select 
                                ...
                                value={medidor.tipo}
                                onChange={(e) => handleMedidorChange(medidor.id, 'tipo', e.target.value)}
                              >
                            ...
                            <div className="col-md-4">
                              ...
                              <input 
                                ...
                                onChange={(e) => handleMedidorChange(medidor.id, 'numero', e.target.value)}
                            ...
                            <div className="col-md-4">
                              ...
                              <input 
                                ...
                                onChange={(e) => handleMedidorChange(medidor.id, 'ubicacion', e.target.value)}
                ...
                <div className="sticky-top" style={{ top: '2rem' }}>
                  ...
                  >
                    ...
                    <div className="p-4">
                      <div className="d-grid gap-2">
                        ...
                        <Link href="/unidades" className="btn btn-outline-secondary">
                  ...
                  >
                    ...
                    <p className="mb-0 small">
                      ...
                      Los m² totales se calculan automáticamente sumando m² útiles y terrazas.
                    </p>
                  </div>
                </div>
              </div>
