                ...
                <div className="col-md-9">
                  <div className="d-flex align-items-center">
                    <div className="me-3" style={{ 
                      ...
                      <i className="material-icons text-white" style={{ fontSize: '36px' }}>business</i>
                    </div>
                    <div>
                      <h4 className="mb-0">Edificio Central</h4>
                      <p className="text-muted mb-0">Av. Principal 123, Santiago</p>
                      <div className="mt-1">
                        <span className="badge bg-info me-1">{stats.totalTorres} Torres</span>
                        <span className="badge bg-secondary">{stats.totalUnidades} Unidades</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-md-3 text-md-end mt-3 mt-md-0">
                  <Link href="/edificios/1" className="btn btn-outline-secondary me-1">
                    <i className="material-icons align-middle me-1">arrow_back</i>
                    Volver
                  </Link>
            ...
            <div className="col-lg-4 d-flex justify-content-end align-items-start">
              <div className="dropdown">
                <button className="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                  <i className="material-icons align-middle me-1">file_download</i>
                  Exportar
                </button>
            ...
            <div className="card shadow-sm mb-4">
              <div className="card-header bg-white d-flex justify-content-between align-items-center">
                ...
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" href="#">Exportar a Excel</a></li>
                    <li><a className="dropdown-item" href="#">Imprimir listado</a></li>
                    <li><hr className="dropdown-divider" /></li>
                    <li><a className="dropdown-item text-danger" href="#">Eliminar seleccionadas</a></li>
                  </ul>
                </div>
              </div>
                        ...
                        <th scope="col" style={{ width: '40px' }}>
                          <div className="form-check">
                            <input 
                              ...
                              checked={selectedTorres.length === filteredAndSortedTorres.length && filteredAndSortedTorres.length > 0}
                    ...
                    <tbody>
                      {filteredAndSortedTorres.map((torre) => (
                        <tr key={torre.id}>
                          <td>
                            <div className="form-check">
                              <input 
                                ...
                                onChange={(e) => handleSelectTorre(torre.id, e.target.checked)}
                              />
                            </div>
                          </td>
                          <td>
                            <div className="d-flex align-items-center">
                              <div className="me-3" style={{ 
                                ...
                                <i className="material-icons text-secondary">location_city</i>
                              </div>
                              <div>
                                <div className="fw-medium">{torre.nombre}</div>
                                <div className="small text-muted">Creada el {formatDate(torre.fechaCreacion)}</div>
                              </div>
                            </div>
                          </td>
                          <td>{torre.codigo}</td>
                          <td>{torre.pisos}</td>
                          <td>
                            <span className="badge bg-secondary">{torre.unidades} unidades</span>
                          </td>
                          <td>
                          ...
                          <td className="text-end">
                            <div className="btn-group">
                              <Link href={`/torres/${torre.id}`} className="btn btn-sm btn-outline-secondary">
                                <i className="material-icons" style={{ fontSize: '16px' }}>visibility</i>
                              </Link>
                              <Link href={`/torres/${torre.id}`} className="btn btn-sm btn-outline-primary">
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-auto">
                    <span className="text-muted">
                      Mostrando 1-{filteredAndSortedTorres.length} de {filteredAndSortedTorres.length} torres
                    </span>
                  </div>
            ...
            <div className="row">
              {filteredAndSortedTorres.map((torre) => (
                <div key={torre.id} className="col-xl-4 col-lg-6 col-md-6 mb-4">
                  <div className="card h-100 torre-card" style={{ position: 'relative', overflow: 'hidden' }}>
                    <div className="position-relative">
                      <img 
                        src={torre.imagen} 
                      ...
                      >
                        <div className="btn-group">
                          <Link href={`/torres/${torre.id}`} className="btn btn-sm btn-light">
                            <i className="material-icons" style={{ fontSize: '16px' }}>edit</i>
                          </Link>
                    ...
                    <div className="card-body">
                      ...
                      <p className="card-text text-muted mb-2">Código: {torre.codigo}</p>
                      ...
                      <div className="d-flex justify-content-between">
                        <Link href={`/torres/${torre.id}`} className="btn btn-outline-primary btn-sm">
                          <i className="material-icons me-1" style={{ fontSize: '16px' }}>visibility</i>
                          Ver detalle
                        </Link>
                        <Link href={`/torres/${torre.id}`} className="btn btn-primary btn-sm">
