...
import { StatusBadge, TypeBadge, ChannelBadge } from '@/components/notificaciones';
...
export default function NotificacionDetalle() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      const mockNotification: NotificationDetail = {
        ...
        message: 'Se realizará mantenimiento preventivo de los ascensores el próximo sábado de 8:00 AM a 12:00 PM. Durante este período, los ascensores no estarán disponibles. Se recomienda a todos los residentes planificar sus actividades considerando esta interrupción temporal del servicio.\n\nEn caso de emergencia, el personal de seguridad estará disponible para asistir a personas con movilidad reducida.\n\nGracias por su comprensión.',
        type: 'maintenance',
        status: 'sent',
        ...
        audience: {
          ...
          details: ['Edificio A: 120 personas', 'Edificio B: 89 personas', 'Edificio C: 36 personas']
        },
        author: {
          name: 'Administración',
          avatar: 'AD',
        ...
        content: {
          ...
          plain: 'Se realizará mantenimiento preventivo de los ascensores el próximo sábado de 8:00 AM a 12:00 PM. Durante este período, los ascensores no estarán disponibles.'
        }
      };
  ...
  const handleDuplicate = () => {
    ...
    sessionStorage.setItem('duplicateNotification', JSON.stringify(duplicateData));
  ...
  const handleResend = () => {
    ...
    if (confirm('¿Estás seguro de que deseas reenviar esta notificación a todos los destinatarios?')) {
  ...
  const handleExport = () => {
    ...
    const exportData = {
      ...
      sentAt: notification.sentAt ? formatDate(notification.sentAt) : 'No enviada',
        ...
        <Layout title='Notificación no encontrada'>
          <div className='container-fluid py-4'>
            <div className='text-center'>
              ...
              <p className='text-muted'>La notificación que buscas no existe o ha sido eliminada.</p>
          ...
          <div className='d-flex justify-content-between align-items-start mb-4'>
            <div className='flex-grow-1 me-3'>
              <div className='d-flex align-items-center gap-2 mb-2'>
                ...
                {notification.priority === 'high' && (
                  <span className='badge bg-danger'>
                    <i className='material-icons me-1' style={{ fontSize: '12px' }}>priority_high</i>
                    Alta Prioridad
                  </span>
                )}
              </div>
              ...
              <div className='text-muted'>
                <span className='me-3'>
                  <i className='material-icons me-1' style={{ fontSize: '16px' }}>person</i>
                  {notification.author.name}
                </span>
                <span className='me-3'>
                  <i className='material-icons me-1' style={{ fontSize: '16px' }}>schedule</i>
                  {notification.sentAt 
                ...
                <span>
                  <i className='material-icons me-1' style={{ fontSize: '16px' }}>people</i>
                ...
                <div className='content-tab'>
                  <div className='card mb-4'>
                    ...
                    <div className='card-body'>
                      <div className='message-content' dangerouslySetInnerHTML={{ __html: notification.content.html }} />
                    </div>
                  </div>
                      ...
                      <div className='row'>
                        ...
                        <div className='col-md-6'>
                          ...
                          <ul className='list-unstyled'>
                            <li>
                              <i className={`material-icons me-2 ${notification.options.trackOpening ? 'text-success' : 'text-muted'}`}>
                                {notification.options.trackOpening ? 'check_circle' : 'radio_button_unchecked'}
                              </i>
                              Rastreo de apertura
                            </li>
                            <li>
                              <i className={`material-icons me-2 ${notification.options.requireConfirmation ? 'text-success' : 'text-muted'}`}>
                                {notification.options.requireConfirmation ? 'check_circle' : 'radio_button_unchecked'}
                              </i>
                ...
                <div className='delivery-tab'>
                  <div className='row mb-4'>
                    <div className='col-md-3 mb-3'>
                      <div className='stats-card text-center' style={{
                        backgroundColor: '#fff',
                        ...
                        <div className='stats-number h3 mb-1'>{notification.deliveryStats.sent}</div>
                    ...
                    <div className='col-md-3 mb-3'>
                      <div className='stats-card text-center' style={{
                        ...
                        <div className='stats-number h3 mb-1'>{notification.deliveryStats.delivered}</div>
                        <div className='stats-label text-muted'>Entregadas</div>
                        <div className='stats-rate small text-success'>{getDeliveryRate()}%</div>
                      </div>
                    </div>
                    <div className='col-md-3 mb-3'>
                      <div className='stats-card text-center' style={{
                        ...
                        <div className='stats-number h3 mb-1'>{notification.deliveryStats.opened}</div>
                        <div className='stats-label text-muted'>Abiertas</div>
                        <div className='stats-rate small text-warning'>{getOpenRate()}%</div>
                      </div>
                    </div>
                    <div className='col-md-3 mb-3'>
                      <div className='stats-card text-center' style={{
                        ...
                        <div className='stats-number h3 mb-1'>{notification.deliveryStats.failed}</div>
                    ...
                    <div className='card-body'>
                      <div className='table-responsive'>
                        <table className='table table-hover'>
                          ...
                          <tbody>
                            <tr>
                              <td><ChannelBadge channel='email' /></td>
                              <td>245</td>
                              <td>240</td>
                              <td>156</td>
                              <td><span className='text-success'>98%</span></td>
                              <td><span className='text-warning'>65%</span></td>
                            </tr>
                            <tr>
                              <td><ChannelBadge channel='sms' /></td>
                              <td>245</td>
                              <td>235</td>
                              <td>89</td>
                              <td><span className='text-success'>96%</span></td>
                              <td><span className='text-warning'>38%</span></td>
                            </tr>
                            <tr>
                              <td><ChannelBadge channel='app' /></td>
                              <td>180</td>
                              <td>175</td>
                              <td>134</td>
                              <td><span className='text-success'>97%</span></td>
                              <td><span className='text-success'>77%</span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <div className='card-body'>
                      <div className='audience-summary mb-4'>
                        <div className='d-flex align-items-center mb-3'>
                          <i className='material-icons me-2 text-primary' style={{ fontSize: '2rem' }}>people</i>
                          <div>
                            <h6 className='mb-0'>{notification.audience.description}</h6>
                            <p className='text-muted mb-0'>{notification.audience.count} destinatarios</p>
                          </div>
                        </div>
                        ...
                        {notification.audience.details && (
                          <div className='audience-breakdown'>
                            ...
                            <ul className='list-unstyled'>
                              {notification.audience.details.map((detail, index) => (
                ...
                <div className='card mb-4'>
                  ...
                  <div className='card-body'>
                    <div className='d-flex align-items-center'>
                      ...
                      <div>
                        <div className='fw-semibold'>{notification.author.name}</div>
                        <div className='small text-muted'>{notification.author.email}</div>
                    ...
                    <div className='related-notifications'>
                      <div className='related-item mb-3 pb-3 border-bottom'>
                        <div className='d-flex align-items-start'>
                          <TypeBadge type='maintenance' size='sm' showIcon={false} />
                          <div className='ms-2 flex-grow-1'>
                            <div className='fw-semibold small'>Finalización de mantenimiento</div>
                      ...
                      <div className='related-item mb-3 pb-3 border-bottom'>
                        <div className='d-flex align-items-start'>
                          <TypeBadge type='announcement' size='sm' showIcon={false} />
                          <div className='ms-2 flex-grow-1'>
                            <div className='fw-semibold small'>Aviso de trabajo en ascensores</div>
                            <div className='text-muted small'>Hace 1 semana</div>
                          </div>
                        </div>
                      </div>
                      <div className='related-item'>
                        <div className='d-flex align-items-start'>
                          ...
                          <div className='ms-2 flex-grow-1'>
                            <div className='fw-semibold small'>Actualización del sistema</div>
                            <div className='text-muted small'>Hace 2 semanas</div>
                          </div>
                        </div>
                      </div>
                    </div>
