...
type NotificationType = 'system' | 'announcement' | 'reminder' | 'alert' | 'maintenance';
        ...
        <div className='container-fluid py-3'>
          ...
          <div className='d-flex justify-content-between align-items-center mb-4'>
            ...
            <div className='d-flex gap-2'>
              ...
              <Link href='/notificaciones' className='btn btn-outline-secondary'>
                Cancelar
              </Link>
            </div>
          </div>
          ...
          <div className='row'>
            <div className={showPreview ? 'col-lg-8' : 'col-12'}>
              {/* Progress Steps */}
              <div className='steps-indicator mb-4' style={{
                backgroundColor: '#fff',
                  ...
                  <div className='col-3'>
                    <div className={`step ${currentStep >= 1 ? 'active' : ''}`}>
                      <div className='step-icon' style={{
                        ...
                        height: '40px',
                        borderRadius: '50%',
                        backgroundColor: currentStep >= 1 ? 'var(--color-primary)' : '#e9ecef',
                  ...
                  <div className='col-3'>
                    <div className={`step ${currentStep >= 2 ? 'active' : ''}`}>
                      <div className='step-icon' style={{
                        ...
                        height: '40px',
                        borderRadius: '50%',
                        backgroundColor: currentStep >= 2 ? 'var(--color-primary)' : '#e9ecef',
                  ...
                  <div className='col-3'>
                    <div className={`step ${currentStep >= 3 ? 'active' : ''}`}>
                      <div className='step-icon' style={{
                        ...
                        height: '40px',
                        borderRadius: '50%',
                        backgroundColor: currentStep >= 3 ? 'var(--color-primary)' : '#e9ecef',
                      ...
                      <div className='step-label text-center'>
                        ...
                        <div className='small text-muted'>Canales y audiencia</div>
                      </div>
                    </div>
                  </div>
                  <div className='col-3'>
                    <div className={`step ${currentStep >= 4 ? 'active' : ''}`}>
                      <div className='step-icon' style={{
                        ...
                        height: '40px',
                        borderRadius: '50%',
                        backgroundColor: currentStep >= 4 ? 'var(--color-primary)' : '#e9ecef',
              ...
              {currentStep === 1 && (
                <div className='step-content' style={{
                  ...
                  <p className='text-muted mb-4'>
                    Elige el tipo que mejor describa tu notificación. Esto ayudará a los destinatarios a entender la importancia y urgencia del mensaje.
                  </p>
                    ...
                    {notificationTypes.map((type) => (
                      <div key={type.id} className='col-md-6 col-lg-4'>
                        <div
                          ...
                          style={{
                            backgroundColor: formData.type === type.id ? type.bg : '#fff',
                            border: formData.type === type.id ? `2px solid ${type.color}` : '1px solid #e9ecef',
                            borderRadius: 'var(--radius)',
                            padding: '1.5rem',
                            cursor: 'pointer',
                        ...
                        >
                          <div className='type-icon mb-3' style={{
                            width: '48px',
                            height: '48px',
                            borderRadius: '50%',
                          ...
                          <p className='type-description text-muted mb-2' style={{ fontSize: '0.875rem' }}>
                            {type.description}
                          </p>
                          <div className='type-examples' style={{ fontSize: '0.75rem', color: type.color }}>
                            Ej: {type.examples}
                          </div>
                          {formData.type === type.id && (
                            <div className='selected-indicator mt-2'>
                              <i className='material-icons' style={{ color: type.color }}>check_circle</i>
                            </div>
                          )}
                        </div>
                      </div>
              ...
              {currentStep === 2 && (
                <div className='step-content' style={{
                  ...
                  <div className='d-flex align-items-center mb-3'>
                    <div className='selected-type-indicator me-3' style={{
                      width: '40px',
                      height: '40px',
                      borderRadius: '50%',
                ...
                <div className='step-content' style={{
                  ...
                  <div className='mb-4'>
                    <label className='form-label'>
                      Canales de comunicación <span className='text-danger'>*</span>
                    </label>
                      ...
                      {channels.map((channel) => (
                        <div key={channel.id} className='col-6 col-md-3'>
                          <div
                            ...
                            style={{
                              backgroundColor: formData.channels.includes(channel.id) ? channel.bg : '#fff',
                          ...
                          >
                            <div className='channel-icon mb-2' style={{
                              color: formData.channels.includes(channel.id) ? channel.color : '#6c757d'
                            }}>
                              <i className='material-icons' style={{ fontSize: '2rem' }}>
                                {channel.icon}
                              </i>
                            </div>
                            <div className='channel-title fw-semibold'>{channel.title}</div>
                  ...
                  <div className='mb-4'>
                    ...
                    <div className='audience-options'>
                      <div className='form-check mb-3'>
                        ...
                        <label className='form-check-label' htmlFor='audience-all'>
                          ...
                          <div className='small text-muted'>Enviar a todas las unidades y residentes</div>
                      ...
                      <div className='form-check mb-3'>
                        ...
                        <label className='form-check-label' htmlFor='audience-building'>
                          ...
                          <div className='small text-muted'>Seleccionar edificios específicos</div>
                        </label>
                      </div>
                      ...
                      <div className='form-check mb-3'>
                        ...
                        <label className='form-check-label' htmlFor='audience-unit'>
                          ...
                          <div className='small text-muted'>Seleccionar unidades específicas</div>
                        </label>
                      </div>
                      ...
                      <div className='form-check mb-3'>
                        ...
                        <label className='form-check-label' htmlFor='audience-custom'>
                          ...
                          <div className='small text-muted'>Seleccionar usuarios específicos o grupos</div>
                        </label>
                      </div>
                    </div>
                    ...
                    {formData.audience.type === 'building' && (
                      <div className='mt-3'>
                        ...
                        <div className='form-text'>Mantén Ctrl/Cmd para seleccionar múltiples edificios</div>
                      </div>
                    )}
                    ...
                    {formData.audience.type === 'unit' && (
                      <div className='mt-3'>
                        ...
                        />
                        <div className='form-text'>Escribe los números de unidad separados por comas</div>
                      </div>
                    )}
                ...
                <div className='step-content' style={{
                  ...
                  <div className='mb-4'>
                    ...
                    <div className='scheduling-options'>
                      <div className='form-check mb-3'>
                        ...
                        />
                        <label className='form-check-label' htmlFor='schedule-now'>
                          <div className='fw-semibold'>Enviar ahora</div>
                          <div className='small text-muted'>La notificación se enviará inmediatamente</div>
                        </label>
                      </div>
                      ...
                      <div className='form-check mb-3'>
                        ...
                        />
                        <label className='form-check-label' htmlFor='schedule-later'>
                          <div className='fw-semibold'>Programar para más tarde</div>
                          <div className='small text-muted'>Selecciona fecha y hora específica</div>
                        </label>
                      </div>
                    </div>
                      ...
                      <div className='mt-3'>
                        <div className='row g-3'>
                          <div className='col-md-6'>
                            <label htmlFor='scheduled-date' className='form-label'>Fecha</label>
                            <input
                              type='date'
                              className='form-control'
                              id='scheduled-date'
                          ...
                          <div className='col-md-6'>
                            <label htmlFor='scheduled-time' className='form-label'>Hora</label>
                            <input
                              type='time'
                              className='form-control'
                              id='scheduled-time'
                  ...
                  <div className='mb-4'>
                    ...
                    >
                      ...
                      <option value='normal'>Normal - Comunicación estándar</option>
                  ...
                  <div className='mb-4'>
                    ...
                    <div className='form-check mb-2'>
                      ...
                      />
                      <label className='form-check-label' htmlFor='track-opening'>
                        <div className='fw-semibold'>Rastrear apertura</div>
                        <div className='small text-muted'>Saber cuándo los destinatarios leen la notificación</div>
                      </label>
                    </div>
                    ...
                    <div className='form-check mb-2'>
                      ...
                      />
                      <label className='form-check-label' htmlFor='require-confirmation'>
                        <div className='fw-semibold'>Requerir confirmación</div>
                        <div className='small text-muted'>Los destinatarios deben confirmar que leyeron el mensaje</div>
                      </label>
                    </div>
                  </div>
            ...
            {showPreview && (
              <div className='col-lg-4'>
                <div className='preview-panel sticky-top' style={{
                  backgroundColor: '#fff',
                  borderRadius: 'var(--radius)',
                  padding: '1.5rem',
                  boxShadow: 'var(--shadow-sm)',
                  ...
                  <div className='preview-notification' style={{
                    border: '1px solid #e9ecef',
                    borderRadius: 'var(--radius)',
                    padding: '1rem',
                    ...
                    <div className='preview-header d-flex align-items-center mb-2'>
                      <div className='preview-type-icon me-2' style={{
                        width: '24px',
                        height: '24px',
                        borderRadius: '50%',
                        backgroundColor: selectedType?.color,
                      ...
                      <span className='small fw-semibold'>{selectedType?.title}</span>
                    </div>
                    ...
                    <div className='preview-message small mb-3'>
                      {formData.message || 'El contenido de la notificación aparecerá aquí...'}
                    </div>
                    ...
                    <div className='preview-audience'>
                      ...
                      <div className='small'>
                        {formData.audience.type === 'all' && 'Todos los residentes'}
                        {formData.audience.type === 'building' && 'Por edificio'}
                        {formData.audience.type === 'unit' && 'Por unidad'}
                        {formData.audience.type === 'custom' && 'Audiencia personalizada'}
                      </div>
                    </div>
                  </div>
                  
                  <div className='preview-stats mt-3'>
                    <div className='small text-muted'>Estadísticas estimadas:</div>
                    <div className='small'>
                      • Destinatarios: ~245 personas<br />
                      • Costo estimado: $0 (canales gratuitos)<br />
                      • Tiempo de envío: ~2-5 minutos
                    </div>
                  </div>
                </div>
              </div>
