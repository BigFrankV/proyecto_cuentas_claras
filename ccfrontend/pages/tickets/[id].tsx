...
export default function TicketDetalle() {
    ...
    if (id) {
      ...
      setTimeout(() => {
        const mockTicket: TicketDetail = {
          ...
          description:
            'El ascensor principal no funciona desde esta mañana. Los residentes no pueden subir a los pisos superiores y esto está causando muchas molestias, especialmente para personas mayores y personas con movilidad reducida. He notado que el ascensor hace un ruido extraño antes de detenerse completamente.',
          status: 'in-progress',
          priority: 'high',
          ...
          timeline: [
            ...
            },
            {
              ...
              user: { name: 'Carlos Técnico', avatar: 'CT' },
              content:
                'He revisado el ascensor y efectivamente hay un problema con el motor. He solicitado las piezas de repuesto.',
            },
            {
              id: '5',
              type: 'attachment',
  ...
  return (
    <ProtectedRoute>
      <Head>
        <title>
          {ticket.number} — {ticket.subject} — Cuentas Claras
        </title>
      </Head>
              ...
              <div className='card mb-4'>
                  ...
                  <h5 className='card-title mb-0'>
                    ...
                    Comentarios (
                    {
                      ticket.comments.filter(
                        c => !c.isInternal || showInternalComments,
                      ).length
                    }
                    )
                  </h5>
                ...
                <div className='card-body'>
                  ...
                  <div className='comments-list mb-4'>
                    {ticket.comments
                      .filter(
                        comment => !comment.isInternal || showInternalComments,
                      )
                      .map(comment => (
                        <div
                          key={comment.id}
