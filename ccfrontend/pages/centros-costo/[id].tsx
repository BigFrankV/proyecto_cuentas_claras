      ...
      <ProtectedRoute>
        <Layout>
          <div className="text-center py-5">
            ...
            <p className="text-muted">El centro de costo que buscas no existe o fue eliminado.</p>
      ...
      <Layout>
            ...
            <div className="d-flex justify-content-between align-items-start mb-4">
              <div>
                ...
                <div className="d-flex align-items-center mb-2">
                  ...
                  <div>
                    <h1 className="cost-center-detail-title mb-1">{costCenter.name}</h1>
                ...
                <div className="d-flex align-items-center gap-2">
                  ...
                  <Badge bg={costCenter.status === 'active' ? 'success' : 'secondary'}>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12">
                      <div className="info-item">
                        ...
                        <div className="info-value">{costCenter.description}</div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="info-item">
              ...
              <Card className="form-section mb-4">
                ...
                <Card.Body className="form-section-body">
                  <div className="d-flex flex-wrap gap-2">
                    {costCenter.responsibilities.map((responsibility, index) => (
                      <Badge 
                        key={index} 
                        bg="light" 
                        text="dark"
                ...
                <Card.Body className="form-section-body">
                  {expenses.length > 0 ? (
                        ...
                        <div key={expense.id} className="expense-item">
                          <div className="d-flex justify-content-between align-items-start">
                            <div className="flex-grow-1">
                              <h6 className="expense-title">{expense.description}</h6>
                              <div className="d-flex align-items-center gap-2 mb-1">
                                <Badge bg="light" text="dark">{expense.category}</Badge>
                    ...
                    <div className="text-center py-4">
                      <span className="material-icons text-muted mb-2" style={{ fontSize: '48px' }}>
                        receipt_long
                      </span>
                      <p className="text-muted">No hay gastos registrados para este centro</p>
                    </div>
                  )}
                </Card.Body>
              </Card>
                  ...
                  <div className="budget-summary">
                    <div className="budget-item mb-3">
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span className="fw-bold">${costCenter.budget.toLocaleString()}</span>
                      </div>
                    </div>
                    ...
                    <div className="budget-item mb-3">
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span className="fw-bold text-primary">${costCenter.spent.toLocaleString()}</span>
                      </div>
                    </div>
                    ...
                    <div className="budget-item mb-3">
                      <div className="d-flex justify-content-between mb-1">
                        ...
                        <span className={`fw-bold ${remainingBudget < 0 ? 'text-danger' : 'text-success'}`}>
                    ...
                    <div className="budget-progress mb-3">
                      <div className="d-flex justify-content-between mb-2">
                        ...
                        <span className="small fw-medium">{budgetPercentage.toFixed(1)}%</span>
                      </div>
                      <ProgressBar 
                        ...
                        className="mb-2"
                      />
                      <small className={`${budgetPercentage > 90 ? 'text-danger' : budgetPercentage > 75 ? 'text-warning' : 'text-success'}`}>
                        {budgetPercentage > 90 ? 'Sobrepresupuesto' : budgetPercentage > 75 ? 'Cerca del límite' : 'En buen estado'}
                      </small>
                    </div>
                    ...
                    <div className="budget-breakdown">
                      ...
                      <div className="monthly-budget">
                        <div className="d-flex justify-content-between">
                          ...
                          <span>${(costCenter.budget / 12).toLocaleString(undefined, { maximumFractionDigits: 0 })}</span>
                        </div>
                        <div className="d-flex justify-content-between">
                          <span className="text-muted">Promedio gastado</span>
                          <span>${(costCenter.spent / 3).toLocaleString(undefined, { maximumFractionDigits: 0 })}</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="form-section">
                ...
                <Card.Body className="form-section-body">
                  <div className="stats-grid">
                    ...
                    <div className="stat-item">
                      <div className="stat-value">{expenses.filter(e => e.status === 'approved').length}</div>
                    ...
                    <div className="stat-item">
                      <div className="stat-value">${(costCenter.spent / expenses.length || 0).toLocaleString(undefined, { maximumFractionDigits: 0 })}</div>
        ...
        <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)} centered>
          ...
          <Modal.Body>
            ...
            <p>¿Estás seguro de que deseas eliminar el centro de costo <strong>"{costCenter.name}"</strong>?</p>
            <p className="text-muted">
              Esto también eliminará toda la información relacionada, incluyendo su historial de gastos y presupuesto.
            </p>
          </Modal.Body>
          <Modal.Footer>
            <Button 
