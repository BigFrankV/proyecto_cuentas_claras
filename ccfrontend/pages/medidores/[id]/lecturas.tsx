              ...
              <div className='d-flex justify-content-between align-items-center'>
                <div>
                  ...
                  <p className='text-muted mb-0'>
                    Registro manual y consulta de lecturas
                  </p>
                </div>
                ...
                <Col md={8} className='d-flex align-items-center'>
                  ...
                  <div>
                    <div className='fw-bold'>
                      Modo de Lectura Masiva Activado
                    </div>
                    <small className='text-muted'>
                      Selecciona múltiples medidores para registrar lecturas de
                      forma eficiente
                    </small>
                  </div>
                </Col>
                      ...
                      >
                        <div className='d-flex justify-content-between align-items-start'>
                          <div>
                            ...
                            <small className='text-muted'>
                              Unidad {meter.unidad} - Torre {meter.torre}
                            </small>
                            <div className='mt-1'>
                              <small className={`text-${meter.estadoColor}`}>
                                {meter.estadoTexto}
                              </small>
                            </div>
                          </div>
                          <div className='text-end'>
                            <div className='fw-bold'>
                              {meter.ultimaLectura.toLocaleString()}{' '}
                              {meter.unidadMedida}
                            </div>
                  ...
                  <Form onSubmit={handleFormSubmit} autoComplete='off'>
                    ...
                    <Form.Group className='mb-3'>
                      ...
                      <InputGroup>
                        ...
                        />
                        <InputGroup.Text>
                          {selectedMeter.unidadMedida}
                        </InputGroup.Text>
                      </InputGroup>
                      <Form.Text>
                        Última lectura: {lastReading.toLocaleString()}{' '}
                        {selectedMeter.unidadMedida}
                      </Form.Text>
                    </Form.Group>
                    <div className='consumption-display mb-3'>
                      <div className='consumption-value'>
                        {consumo.toLocaleString()} {selectedMeter.unidadMedida}
                      </div>
                    ...
                    <Form.Group className='mb-3'>
                      ...
                      >
                        ...
                        <small className='text-muted'>
                          Opcional - Evidencia de la lectura
                        </small>
                      </div>
                      <Form.Control
                        type='file'
            ...
            <Col xs={12} lg={7}>
              <Card className='reading-history'>
                <Card.Header className='reading-history-header'>
                  <div className='d-flex justify-content-between align-items-center'>
                    <h5 className='mb-0'>
                      Historial de Lecturas - {selectedMeter.id}
                    </h5>
                    ...
                    history.map(reading => (
                      <div key={reading.id} className='reading-item'>
                        <div className='d-flex justify-content-between align-items-start'>
                          <div>
                            <div className='fw-bold'>
                              {new Date(reading.fecha).toLocaleString('es-CL')}
                            </div>
                            <div className='text-primary fw-bold'>
                              {reading.valor.toLocaleString()}{' '}
                              {selectedMeter.unidadMedida}
                            </div>
                            <small className='text-muted'>
                              Consumo: {reading.consumo.toLocaleString()}{' '}
                              {selectedMeter.unidadMedida}
                            </small>
                          </div>
                          <div className='text-end'>
                            <span
                              className={`status-badge status-${estadoBadge[reading.estado] || 'secondary'} mb-2`}
                            >
                              {reading.estado.charAt(0).toUpperCase() +
                                reading.estado.slice(1)}
                            </span>
                            ...
                            <div className='mt-2'>
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  setShowPhotoModal(reading.fotoUrl || '')
                                }
                              >
                ...
                <Row>
                  <Col xs={6}>
                    <Button
                      variant='outline-primary'
                      className='w-100'
                      onClick={() => alert('Generando reporte de lecturas...')}
                    >
                      {' '}
                      <Assessment className='me-1' /> Generar Reporte{' '}
                    </Button>
                  </Col>
                  <Col xs={6}>
                    <Button
                    ...
                    >
                      {' '}
                      <FileDownload className='me-1' /> Exportar Datos{' '}
                    </Button>
                  </Col>
                </Row>
              </div>
