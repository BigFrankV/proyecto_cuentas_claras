      ...
      <ProtectedRoute>
        <Layout title="Edificio no encontrado">
          <div className="text-center py-5">
            <i className="material-icons mb-3" style={{ fontSize: '64px', color: '#ddd' }}>error</i>
            <h3>Edificio no encontrado</h3>
            <p className="text-muted">El edificio que intentas editar no existe o no tienes permisos para acceder a él.</p>
              ...
              <form onSubmit={handleSubmit} className="row g-3">
                ...
                <div className="col-12">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>info</i>
                    Información Básica
                  </h6>
                </div>
                ...
                <div className="col-12 mt-4">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>apartment</i>
                    Información Estructural
                  </h6>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-4 mb-3">
                    ...
                    {errors.anoConstructccion && (
                      <div className="invalid-feedback">{errors.anoConstructccion}</div>
                    )}
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-3 mb-3">
                    ...
                    />
                    {errors.areaPrivada && (
                      <div className="invalid-feedback">{errors.areaPrivada}</div>
                    )}
                  </div>
                  ...
                  <div className="col-md-3 mb-3">
                    ...
                    />
                    {errors.parqueaderos && (
                      <div className="invalid-feedback">{errors.parqueaderos}</div>
                    )}
                  </div>
                ...
                <div className="col-12 mt-4">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>build</i>
                      ...
                      <div key={servicio.value} className="col-md-4 mb-2">
                        <div className="form-check">
                          <input
                            ...
                            checked={formData.servicios?.includes(servicio.value) || false}
                ...
                <div className="col-12 mt-4">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>pool</i>
                    Amenidades
                  </h6>
                  <div className="row">
                      ...
                      <div key={amenidad.value} className="col-md-4 mb-2">
                        <div className="form-check">
                          <input
                            ...
                            checked={formData.amenidades?.includes(amenidad.value) || false}
                ...
                <div className="col-12 mt-4">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>contact_phone</i>
                    Información de Contacto
                  </h6>
                </div>
                ...
                <div className="row">
                  <div className="col-md-4 mb-3">
                    ...
                    {errors.administrador && (
                      <div className="invalid-feedback">{errors.administrador}</div>
                    )}
                  </div>

                  <div className="col-md-4 mb-3">
                    <label htmlFor="telefonoAdministrador" className="form-label">
                      Teléfono
                    </label>
                    <input
                      type="tel"
                    ...
                    {errors.telefonoAdministrador && (
                      <div className="invalid-feedback">{errors.telefonoAdministrador}</div>
                    )}
                  </div>
                ...
                <div className="col-12 mt-4">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>location_on</i>
                    Ubicación
                  </h6>
                </div>
                ...
                <div className="col-12 mt-4">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>photo_camera</i>
                    Imagen del Edificio
                  </h6>
                  <div className="row">
                ...
                <div className="col-12 mt-4">
                  <h6 className="fw-bold text-primary mb-3">
                    <i className="material-icons me-2" style={{fontSize: '18px'}}>notes</i>
                    Observaciones
                  </h6>
                  <textarea
                ...
                <div className="col-12 mt-4">
                  <div className="d-flex gap-2">
                    ...
                    <Link href={`/edificios/${id}`} className="btn btn-outline-secondary">
