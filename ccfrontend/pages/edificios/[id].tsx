      ...
      <ProtectedRoute>
        <Layout title="Error">
          <div className="text-center py-5">
            <i className="material-icons mb-3" style={{ fontSize: '64px', color: '#dc3545' }}>error_outline</i>
      ...
      <Layout title={edificio.nombre}>
            ...
            <div className='edificio-cover-overlay'>
              <div className='cover-actions'>
                <div className='btn-group'>
                  <Link href={`/edificios/${id}/editar`} className='btn btn-light btn-sm'>
          ...
          <div className='row mb-4'>
            ...
            <div className='col-lg-3 col-md-6 mb-3'>
              <div className='stat-card'>
                ...
                <div className='stat-content'>
                  <div className='stat-value'>{edificio.totalUnidadesOcupadas}</div>
              ...
              <div className='stat-card'>
                ...
                <div className='stat-content'>
                  <div className='stat-value'>
                    {((edificio.totalUnidadesOcupadas / edificio.totalUnidades) * 100).toFixed(1)}%
                  </div>
                      ...
                      <div className='row'>
                        <div className='col-md-6'>
                          <div className='detail-item'>
                            ...
                            <div className='detail-value'>{edificio.nombre}</div>
                          </div>
                        </div>
                        <div className='col-md-6'>
                          <div className='detail-item'>
                            <div className='detail-label'>Código</div>
                            <div className='detail-value'>{edificio.codigo || 'N/A'}</div>
                          </div>
                        </div>
                        <div className='col-md-6'>
                          <div className='detail-item'>
                        ...
                        <div className='col-md-6'>
                          <div className='detail-item'>
                            <div className='detail-label'>Año de Construcción</div>
                            <div className='detail-value'>{edificio.anoConstructccion || 'N/A'}</div>
                          </div>
                        </div>
                        <div className='col-12'>
                          <div className='detail-item'>
                            <div className='detail-label'>Dirección</div>
                            <div className='detail-value'>{edificio.direccion}</div>
                          </div>
                        </div>
                        <div className='col-12'>
                          <div className='detail-item'>
                            <div className='detail-label'>Comunidad</div>
                            <div className='detail-value'>{edificio.comunidadNombre}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className='row'>
                        ...
                        <div className='col-md-3'>
                          <div className='detail-item'>
                            ...
                            <div className='detail-value'>{edificio.areaComun} m²</div>
                          </div>
                        </div>
                        <div className='col-md-3'>
                          <div className='detail-item'>
                            <div className='detail-label'>Parqueaderos</div>
                            <div className='detail-value'>{edificio.parqueaderos}</div>
                          </div>
                        </div>
                        <div className='col-md-3'>
                          <div className='detail-item'>
                            <div className='detail-label'>Depósitos</div>
                            <div className='detail-value'>{edificio.depositos}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='content-section'>
                    ...
                    <div className='content-section-body'>
                      <div className='detail-item'>
                        ...
                        <div className='detail-value'>{edificio.administrador || 'N/A'}</div>
                      </div>
                      <div className='detail-item'>
                            ...
                            <div className='flex-grow-1'>
                              <div className='d-flex justify-content-between align-items-start'>
                                <div>
                                  ...
                                  <p className='text-muted small mb-1'>{torre.codigo}</p>
                                  <p className='text-muted small mb-0'>{torre.observaciones}</p>
                                </div>
                                <div className='text-end'>
                                  <div className='fw-semibold'>{torre.unidadesOcupadas}/{torre.totalUnidades}</div>
                          ...
                          <div className="card h-100">
                            <div className="card-body">
                              <div className="d-flex justify-content-between align-items-start mb-2">
                                <h6 className="card-title mb-0">{unidad.numero}</h6>
                                <span className={`badge ${unidad.estado === 'ocupada' ? 'bg-success' : 'bg-secondary'}`}>
                                  {unidad.estado}
                                </span>
                              </div>
                              <p className="text-muted small mb-2">
                                Torre ID: {unidad.torreId || 'N/A'} | Piso: {unidad.piso}
                              </p>
                              {unidad.area && (
                                <p className="text-muted small mb-2">
                                  Área: {unidad.area} m²
                          ...
                          <div key={servicio.value} className='col-md-6 mb-2'>
                            <div className='d-flex align-items-center'>
                              <i className={`material-icons me-2 ${
                                (edificio.servicios || []).includes(servicio.value) 
                                  ? 'text-success' 
                                  : 'text-muted'
                              }`}>
                                {(edificio.servicios || []).includes(servicio.value) 
                      ...
                      <div className='row'>
                        {AMENIDADES_DISPONIBLES.map(amenidad => (
                          <div key={amenidad.value} className='col-md-6 mb-2'>
                            <div className='d-flex align-items-center'>
                              <i className={`material-icons me-2 ${
                                (edificio.amenidades || []).includes(amenidad.value) 
                                  ? 'text-success' 
                                  : 'text-muted'
                              }`}>
                                {(edificio.amenidades || []).includes(amenidad.value) 
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>¿Estás seguro de que deseas eliminar el edificio <strong>{edificio.nombre}</strong>?</p>
        ...
        <style jsx>{`
          ...
          .edificio-cover-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(0deg, rgba(3,14,39,0.7) 0%, rgba(3,14,39,0.4) 50%, rgba(3,14,39,0.2) 100%);
            display: flex;
