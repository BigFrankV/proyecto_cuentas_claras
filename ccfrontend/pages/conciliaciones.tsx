...
export default function ConciliacionesListado() {
  ...
  const stats = {
    ...
    withDifferences: conciliaciones.filter(c => c.status === 'with-differences')
      .length,
  };
                      ...
                      <tr key={conciliacion.id}>
                        <td>
                          <div className='fw-semibold'>
                            {formatPeriod(conciliacion.period)}
                          </div>
                        ...
                        <td>
                          <span
                            className={`difference-indicator ${conciliacion.difference === 0 ? 'zero' : conciliacion.difference > 0 ? 'positive' : 'negative'}`}
                          >
                          ...
                          <div className='progress-container'>
                            <div className='progress'>
                              <div
                                ...
                                style={{
                                  width: `${getProgressPercentage(conciliacion.matchedTransactions, conciliacion.totalTransactions)}%`,
                                }}
                              ></div>
                            </div>
