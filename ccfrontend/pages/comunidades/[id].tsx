...
// eslint-disable-next-line no-console
      ...
      const errorMessage =
        ...
        error?.message ||
        'Error al cargar la comunidad. Por favor, intente nuevamente.';
...
// eslint-disable-next-line no-console
      ...
      const errorMessage =
        error?.response?.data?.message ||
        error?.message ||
        'Error al cargar las amenidades';
      ...
      <ProtectedRoute>
        <Layout title='Comunidad no encontrada'>
          <div className='text-center py-5'>
            ...
            <Link href='/comunidades' className='btn btn-primary'>
              Volver al listado
            </Link>
          </div>
        </Layout>
              ...
              <div className='cover-actions'>
                <div className='dropdown'>
                  ...
                  <ul className='dropdown-menu dropdown-menu-end'>
                    ...
                    <li>
                      <Link
                        href={`/comunidades/${id}/parametros`}
                        className='dropdown-item'
                      >
                    ...
                    <div className='row'>
                      ...
                      <div className='col-md-6'>
                        <div className='detail-item'>
                          ...
                          <div className='detail-value'>
                            {comunidad.telefono || 'No especificado'}
                          </div>
                        </div>
                        <div className='detail-item'>
                          <div className='detail-label'>Email</div>
                          <div className='detail-value'>
                            {comunidad.email || 'No especificado'}
                          </div>
                        </div>
                        <div className='detail-item'>
                          ...
                          <div className='detail-value'>
                            {comunidad.horarioAtencion || 'No especificado'}
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='content-section-body p-0'>
                    ...
                    {amenidades && amenidades.length > 0 ? (
                          ...
                          <div>
                            ...
                            {amenidad.requiereReserva && (
                              <small className='text-muted d-block'>
                                Requiere reserva{' '}
                                {amenidad.costoReserva > 0 &&
                                  `- ${comunidadesService.formatCurrency(amenidad.costoReserva)}`}
                              </small>
                            )}
                          </div>
                          <span
                            className={`badge ${
                              amenidad.estado === 'Disponible'
                                ? 'bg-success'
                                : amenidad.estado === 'Mantenimiento'
                                  ? 'bg-warning'
                                  : 'bg-danger'
                            }`}
                          >
                      ...
                      <div className='p-4 text-center text-muted'>
                        <span
                          className='material-icons mb-2 d-block'
                          style={{ fontSize: '48px' }}
                        >
                          spa
                        </span>
                        ...
                        <div className='map-address'>
                          ...
                          <div>
                            ...
                            <p className='map-address-details'>
                              <a
                                href={`https://maps.google.com/?q=${encodeURIComponent(comunidad.direccion)}`}
                                target='_blank'
                          ...
                          <tbody>
                            {residentes.map(residente => (
                              <tr key={residente.id}>
                                ...
                                <td>
                                  <span
                                    className={`badge ${residente.estado === 'Activo' ? 'bg-success' : 'bg-secondary'}`}
                                  >
                                    {residente.estado}
                                  </span>
                                </td>
                  ...
                  <div className='content-section-body'>
                    <div className='chart-placeholder text-center py-5'>
                      ...
                      <p className='text-muted'>
                        Implementar con Chart.js o biblioteca similar
                      </p>
                    </div>
                  </div>
                </div>
