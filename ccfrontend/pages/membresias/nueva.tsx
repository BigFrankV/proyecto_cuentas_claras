                  ...
                  <div className='row g-3'>
                    {tiers.map(tier => (
                      <div key={tier.id} className='col-12 col-md-6 col-lg-3'>
                        ...
                        >
                          <div
                            className={`tier-badge ${tier.className} mb-2`}
                            style={{
                ...
                >
                  <div className='alert alert-info' role='alert'>
                    <div className='d-flex'>
                      ...
                      <div>
                        Por favor, primero seleccione un nivel de membresía para
                        continuar con la selección del miembro.
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div className='alert alert-info' role='alert'>
                    <div className='d-flex'>
                      <i className='material-icons me-2'>info</i>
                      <div>
                        Complete los pasos previos para configurar las fechas de
                        la membresía.
                      </div>
                    </div>
                  </div>
                ...
                >
                  <div className='alert alert-info' role='alert'>
                    <div className='d-flex'>
                      <i className='material-icons me-2'>info</i>
                      <div>
                        Complete los pasos previos para configurar el pago de la
                        membresía.
                      </div>
                    </div>
                  </div>
