...
const ValidadorRUT: React.FC = () => {
  ...
  const [generateFormat, setGenerateFormat] = useState<'dots' | 'clean' | 'dash'>('dots');
  ...
  const formatRut = (rut: string, format: 'dots' | 'clean' | 'dash' = 'dots'): string => {
      ...
      <div className="container-fluid px-4 py-4">
        ...
        {showCopiedAlert && (
          <div className="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <strong>¡Copiado!</strong> RUT "{showCopiedAlert}" copiado al portapapeles.
            <button 
              type="button" 
              className="btn-close" 
            ...
            <div className="card h-100">
              ...
              <div className="card-body">
                <div className="mb-3">
                  ...
                  {validation && (
                    <div className={`mt-2 ${validation.isValid ? 'text-success' : 'text-danger'}`}>
                      <i className={`material-icons me-1 ${validation.isValid ? 'text-success' : 'text-danger'}`}>
                      ...
                      {validation.isValid ? (
                        <span>
                          ...
                          <button 
                            ...
                            onClick={() => copyToClipboard(validation.formatted)}
                          >
                      ...
                      <div key={index} className="col-12">
                        <div className="d-flex align-items-center p-2 bg-light rounded">
                          <div className="flex-grow-1">
                            ...
                            <code className="text-primary">{example.example}</code>
                ...
                <div className="row g-3 mb-3">
                  ...
                  <div className="col-md-6">
                    ...
                    <select 
                      ...
                      onChange={(e) => setGenerateFormat(e.target.value as 'dots' | 'clean' | 'dash')}
                    >
                  ...
                  <div className="mt-3">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      ...
                      <button 
                        className="btn btn-sm btn-outline-primary"
                        onClick={() => {
                          const allRuts = generatedRuts.map(r => r.formatted).join('\n');
                    ...
                    <div className="list-group list-group-flush" style={{ maxHeight: '300px', overflowY: 'auto' }}>
                      {generatedRuts.map((rut, index) => (
                        <div key={index} className="list-group-item d-flex justify-content-between align-items-center">
                          <div>
                            <code className="text-primary fw-bold">{rut.formatted}</code>
                            <small className="text-muted ms-2">DV: {rut.digitoVerificador}</small>
                          </div>
                          <button 
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <p className="text-muted">
                      El RUT (Rol Único Tributario) es un identificador único asignado por el Servicio de Impuestos Internos (SII) 
                      a cada persona natural o jurídica en Chile.
                    </p>
                    
                    <h6>Estructura del RUT:</h6>
                    <ul className="text-muted">
                      <li><strong>Número:</strong> Entre 1.000.000 y 99.999.999</li>
                      <li><strong>Dígito verificador:</strong> Calculado mediante algoritmo matemático</li>
                      <li><strong>Formato:</strong> XX.XXX.XXX-Y donde Y puede ser 0-9 o K</li>
                    </ul>
                  </div>
                  ...
                  <div className="col-md-6">
                    ...
                    <ol className="text-muted">
                      <li>Se toman los dígitos del RUT (sin DV) de derecha a izquierda</li>
                      <li>Se multiplican por la secuencia 2, 3, 4, 5, 6, 7, 2, 3...</li>
                    ...
                    <div className="alert alert-info mt-3">
                      ...
                      <strong>Nota:</strong> Esta herramienta genera RUTs válidos para testing, 
                      no representa RUTs reales de personas existentes.
                    </div>
                  </div>
                </div>
              </div>
